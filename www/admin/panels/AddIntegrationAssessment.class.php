<?php
    class AddIntegrationAssessment extends QPanel {
        ...
        protected $strTemplate = '../../admin/panels/AddIntegrationAssessment.tpl.php';
      ...
      //  protected $strBackColor = '#fefece';
        ...
        public function __construct($objParentObject, $strMethodCallBack, $objParent, $strControlId = null) {
			...
			$this->btnSubmit->Text = "Add Users to Integration Assessment";
