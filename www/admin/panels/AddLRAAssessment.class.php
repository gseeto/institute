<?php
    class AddLRAAssessment extends QPanel {
        ...
        protected $strTemplate = '../../admin/panels/AddLRAAssessment.tpl.php';
      ...
      //  protected $strBackColor = '#fefece';
        ...
        public function __construct($objParentObject, $strMethodCallBack, $objParent, $strControlId = null) {
			...
			$this->btnSubmit->Text = "Add Users to Leadership Readiness Assessment";
