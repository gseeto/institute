<?php
    ...
    class AddMembersPanel extends QPanel {
        ...
        // The Company object we're attempting to associate Recipes with
        protected $objCompany;
        protected $selectedUserArray;
        protected $strMethodCallBack;
    
        // Specify the Template File for this custom QPanel
        protected $strTemplate = 'addMembersPanel.tpl.php';
        ...
        public function __construct($objParentObject, $objCompany, $strMethodCallBack, $strControlId = null) {
			...
			$this->dtgUsers->GridLines = 'horizontal';
			...
			$this->btnSubmit->Text = "Add Users to Company";
    ...
    public function dtgUsers_Refresh($strFormId, $strControlId, $strParameter) {
     ...
     public function btnSubmit_Click($strFormId, $strControlId, $strParameter) {
		...
		foreach($this->selectedUserArray as $intUserId) {
			$this->objCompany->AssociateUser(User::Load($intUserId));
		}
		$this->Visible = false;
