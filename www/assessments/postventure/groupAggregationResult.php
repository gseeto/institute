...
class GroupPostVentureAggregationResultForm extends InstituteForm {
	protected $arrNavigation;
	protected $strPageTitle = 'Post Venture Group Assessments';
	...
	protected function Form_Create() {
		...
		$groupArray = PostventureAssessment::LoadArrayByGroupId($this->objGroupAssessment->Id);	
		...
		$content = array('<img src=\''.__SUBDIRECTORY__.'/assessments/postventure/groupSpiderImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/postventure/groupTitleGapImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/postventure/groupTenureGapImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/postventure/groupCountryGapImg.php/'.$strArgs.'\' />');
        ...
        $this->dtgUsers->MetaAddEditLinkColumn('<?=__SUBDIRECTORY__.InstituteForm::DirAssessments."/postventure/viewAssessment.php/".$_ITEM->Id ?>','<?= $_FORM->RenderName($_ITEM)?>','Name');
	...
	public function chkSelected_Render(User $objUser, $intRow) {
		...
		$postventureArray = $objUser->GetPostventureAssessmentArray();
        ...
        if (!$chkSelected) {
            ...
            $chkSelected->ActionParameter = $postventureArray[0]->Id;
...
GroupPostVentureAggregationResultForm::Run('GroupPostVentureAggregationResultForm');
?>