...
class LemonGroupResultsForm extends InstituteForm {
	...
	protected function Form_Run() {
		...
		if (!QApplication::$Login) QApplication::Redirect('/resources/assessments/lemon/groupLogin.php');
	}
...
Your results are provided below. For future reference, if you'd like to review your results you can do so at <a href='http://localhost/resources'>The Institute Portal</a> and by logging in using the Username/Password you created earlier.";
