...
class LemonLoadQuestionsForm extends InstituteForm {
	...
	protected function Form_Create() {	
		...
		$this->dtgAssessmentQuestions = new Lemon50AssessmentDataGrid($this);
	...
	public function dtgAssessmentQuestions_Bind() {
		...
		$assessmentArray = Lemon50AssessmentQuestions::QueryArray($objConditions,$objClauses);		
		$this->dtgAssessmentQuestions->DataSource = $assessmentArray; 
	}
	
    public function lstAnswer_Render(Lemon50AssessmentQuestions $objQuestions) {
...
LemonLoadQuestionsForm::Run('LemonLoadQuestionsForm');