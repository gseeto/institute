...
// Disable strict no-cache for IE due to IE issues with downloading no-cache items
	...
	print "Name,Luminary,Entrepreneur,Manager,Organizer,Networker\r\n";
	...
	foreach($assessmentArray as $intAssessmentId) {
		...
		$objAssessment->User->FirstName, $objAssessment->User->LastName, $objAssessment->L,$objAssessment->E,$objAssessment->M,$objAssessment->O,$objAssessment->N);		
	}
?>