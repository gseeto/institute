...
class LemonLoadResultsForm extends InstituteForm {
...
/*	public function dtgAssessmentResults_Bind() {
		$assessmentArray = Lemon50AssessmentResults::LoadArrayByAssessmentId($this->objLemonAssessment->Id);		
...
LemonLoadResultsForm::Run('LemonLoadResultsForm');
?>