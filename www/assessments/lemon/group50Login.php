...
class LemonGroup50LoginForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {
		...
		if (!$objGroupAssessment) {
			...
			if ($objGroupAssessment->KeysLeft <= 0) {
				...
				QApplication::Redirect(__SUBDIRECTORY__.'/assessments/lemon/group50Info.php/'.$objGroupAssessment->Id);
			}
		}
	}
...
LemonGroup50LoginForm::Run('LemonGroup50LoginForm');
?>