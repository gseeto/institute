...
class NewLemonAssessmentFrenchForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {	
		...
		QApplication::Redirect(__SUBDIRECTORY__.'/assessments/lemon/french/viewAssessment.php');
	}
...
NewLemonAssessmentFrenchForm::Run('NewLemonAssessmentFrenchForm');
?>