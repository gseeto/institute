...
class ViewLemonAssessmentFrenchForm extends InstituteForm {
	...
	protected function btnReturn_Click() {
		QApplication::Redirect(__SUBDIRECTORY__.'/assessments/lemon/french/index.php');
	}
...
ViewLemonAssessmentFrenchForm::Run('ViewLemonAssessmentFrenchForm');
?>