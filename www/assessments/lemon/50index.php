...
class LemonAssessment50Form extends InstituteForm {
	...
	protected function Form_Create() {		
		...
		if($assessmentArray)
			...
			$this->objLemonAssessment = new Lemon50Assessment();
		...
		switch($this->objLemonAssessment->ResourceStatusId) {
			...
			case 2:
				...
				break;
			case 3:				
				$this->lblMsg->Text = 'Your LEMON Assessment has been deactivated. Contact the Administrator if you wish it reactivated.';
				break;
		}
	}
	...
	protected function btnView_Click() {	
		QApplication::Redirect('view50Assessment.php');
	}
}

LemonAssessment50Form::Run('LemonAssessment50Form');
?>