...
class IntegrationGroupLoginForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {
		...
		if (!$objGroupAssessment) {
			...
			if ($objGroupAssessment->KeysLeft <= 0) {
				...
				QApplication::Redirect(__SUBDIRECTORY__.'/assessments/integration/groupInfo.php/'.$objGroupAssessment->Id);
			}
		}
	}
...
IntegrationGroupLoginForm::Run('IntegrationGroupLoginForm');
?>