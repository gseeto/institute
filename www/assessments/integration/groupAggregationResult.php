...
class GroupIntegrationAggregationResultForm extends InstituteForm {
	...
	protected function Form_Create() {
        ...
        $this->dtgUsers->MetaAddEditLinkColumn('<?=__SUBDIRECTORY__.InstituteForm::DirAssessments."/integration/viewAssessment.php/".$_ITEM->Id ?>','<?= $_FORM->RenderName($_ITEM)?>','Name');
...
GroupIntegrationAggregationResultForm::Run('GroupIntegrationAggregationResultForm');
?>