...
class LRAGroupQuestions extends InstituteForm {
	...
	protected function btnSubmit_Click() {	
        ...
        $objGroupAssessment = GroupAssessmentList::Load($this->objLRAAssessment->GroupId);
        $objGroupAssessment->KeysLeft--;
        $objGroupAssessment->Save();
		QApplication::Redirect(__SUBDIRECTORY__.'/assessments/lra/groupResults.php');
	}
...
LRAGroupQuestions::Run('LRAGroupQuestions');
?>