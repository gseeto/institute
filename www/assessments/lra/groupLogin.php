...
class LRAGroupLoginForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {
		...
		if (!$objGroupAssessment) {
			...
			if ($objGroupAssessment->KeysLeft <= 0) {
				...
				QApplication::Redirect(__SUBDIRECTORY__.'/assessments/lra/groupInfo.php/'.$objGroupAssessment->Id);
			}
		}
	}
...
LRAGroupLoginForm::Run('LRAGroupLoginForm');
?>