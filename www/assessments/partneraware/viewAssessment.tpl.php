	...
	<div class="col-md-8 section">
		...
		<script type="text/javascript">
		         ...
		         // RADAR CHART
		            ...
		            chart.addTitle("PArtnering Awareness Assessment", 14, '#000000', 0, true);
		...
		<img src='<?php _p(__SUBDIRECTORY__);?>/assessments/partneraware/partnerAwareAssessmentImg.php/<?php _p($this->objPartneringAwarenessAssessment->Id);?>'>
	</div>
	<div class="col-md-2">&nbsp;</div>
</div>
