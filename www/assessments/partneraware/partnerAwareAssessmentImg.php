...
// Setup graph titles
$graph->title->Set("Partnering Awareness Assessment");
...
foreach(CategoryType::$NameArray as $key=>$value) {
	...
	$resultArray = PartneringAwarenessResults::LoadArrayByAssessmentIdAndCategory($intAssessmentId,$key);
	$ptotal = $itotal = 0;
...
$fileName =  __UPLOAD_DIR__.'/partneraware' . $intAssessmentId. '.png';
