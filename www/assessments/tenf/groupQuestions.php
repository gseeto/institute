...
class TenFGroupQuestions extends InstituteForm {
	...
	protected function btnSubmit_Click() {	
        ...
        $objGroupAssessment = GroupAssessmentList::Load($this->objTenFAssessment->GroupId);
        $objGroupAssessment->KeysLeft--;
        $objGroupAssessment->Save();
		QApplication::Redirect(__SUBDIRECTORY__.'/assessments/tenf/groupResults.php');
	}
...
TenFGroupQuestions::Run('TenFGroupQuestions');
?>