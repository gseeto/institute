...
class NewTenFAssessmentForm extends InstituteForm {
	...
	protected function Form_Create() {		
		...
		//$this->objTenFAssessment->ResourceStatusId
		$this->dtgAssessmentQuestions = new TenFQuestionsDataGrid($this);
		$this->dtgAssessmentQuestions->MetaAddTypeColumn('CategoryId', 'FCategoryType');
	...
	public function dtgAssessmentQuestions_Bind() {
		...
		$assessmentArray = TenFQuestions::QueryArray($objConditions,$objClauses);		
