...
class FGroupLoginForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {
		...
		if (!$objGroupAssessment) {
			...
			if ($objGroupAssessment->KeysLeft <= 0) {
				...
				QApplication::Redirect(__SUBDIRECTORY__.'/assessments/tenf/groupInfo.php/'.$objGroupAssessment->Id);
			}
		}
	}
...
FGroupLoginForm::Run('FGroupLoginForm');
?>