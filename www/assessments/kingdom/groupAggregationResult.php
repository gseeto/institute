...
class GroupKingdomAggregationResultForm extends InstituteForm {
	protected $arrNavigation;
	protected $strPageTitle = 'Group Kingdom Business Assessments Aggregation';
	...
	protected function Form_Create() {
		...
		$groupArray = KingdomBusinessAssessment::LoadArrayByGroupId($this->objGroupAssessment->Id);	
		...
		$content = array('<img src=\''.__SUBDIRECTORY__.'/assessments/kingdom/groupSpiderImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/kingdom/groupTitleGapImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/kingdom/groupTenureGapImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/kingdom/groupCountryGapImg.php/'.$strArgs.'\' />');
        ...
        $this->dtgUsers->MetaAddEditLinkColumn('<?=__SUBDIRECTORY__.InstituteForm::DirAssessments."/kingdom/viewAssessment.php/".$_ITEM->Id ?>','<?= $_FORM->RenderName($_ITEM)?>','Name');
	...
	public function chkSelected_Render(User $objUser, $intRow) {
		...
		$kingdomArray = $objUser->GetKingdomBusinessAssessmentArray();
        ...
        if (!$chkSelected) {
            ...
            $chkSelected->ActionParameter = $kingdomArray[0]->Id;
...
GroupKingdomAggregationResultForm::Run('GroupKingdomAggregationResultForm');
?>