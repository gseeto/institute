	...
	<div class="col-md-8 section">
		...
		<script type="text/javascript">
		         ...
		         // RADAR CHART
		            ...
		            chart.addTitle("Partnering Readiness Assessment", 14, '#000000', 0, true);
		            ...
		            graph2.valueField = "willingness";
		            graph2.bullet = "round";
		            graph2.bulletAlpha = 0.7;
		            graph2.fillAlphas = 0.4;
		            graph2.balloonText = "[[category]] Willingness: [[value]]"
		...
		<p>Large gaps between Importance and Willingness indicate areas for improvement. Low scores  may suggest areas you have not considered but may be beneficial in improving impact.</p>
		<p>Your largest gap between Importance and Willingness appears to be under <b><?php $this->lblDelta->Render();?></b>. This may indicate areas of improvement.</p>
		...
		<img src='<?php _p(__SUBDIRECTORY__);?>/assessments/partnerready/partnerReadinessAssessmentImg.php/<?php _p($this->objPartneringReadinessAssessment->Id);?>'>
	</div>
	<div class="col-md-2">&nbsp;</div>
</div>
