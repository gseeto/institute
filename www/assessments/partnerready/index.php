...
class PartneringReadinessAssessmentForm extends InstituteForm {
	...
	protected function Form_Create() {		
		...
		// 2 = touched
		// 3 = inactive
		switch($this->objPartneringReadinessAssessment->ResourceStatusId) {
			case 1:
			...
			case 2:
				...
				break;
			case 3:				
				$this->lblMsg->Text = 'Your Partnering Readiness Assessment has been deactivated. Contact the Administrator if you wish it reactivated.';
				break;
		}
	}
	
	protected function btnEdit_Click() {	
		if ($this->objPartneringReadinessAssessment->ResourceStatusId == 1) {
...
PartneringReadinessAssessmentForm::Run('PartneringReadinessAssessmentForm');
?>