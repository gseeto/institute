...
<script type="text/javascript">						
            function DisplayChart(chartData) {
                ...
                // TITLE
                chart.addTitle("Partnering Readiness Assessment", 20);
                ...
                graph2.balloonText = "[[category]] Willingness: [[willingness]]";
...
<div class="row">
	...
	<div class="col-md-8 section">
		...
		<span class="text-danger">IMPORTANCE: Please evaluate how important this statement is to the overall purpose and impact of your Company.</span>
		<br>
		<span class="text-primary">WILLINGNESS: Please evaluate how you willing you are relative to the importance you assigned.</span>
		</p>
