...
class ViewLemonloversAssessmentForm extends InstituteForm {
	...
	protected function btnGeneratePdf_Click() { 
		...
		$objPage1->drawText("LEMON Lovers Assessment Report", 50, $PageHeight, 'UTF-8');
...
ViewLemonloversAssessmentForm::Run('ViewLemonloversAssessmentForm');
?>