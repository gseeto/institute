...
class NewLemonloversAssessmentForm extends InstituteForm {
	protected $arrNavigation;
	protected $strPageTitle = 'LEMON for Lovers Assessment';
	...
	protected function Form_Create() {		
		...
		if($assessmentArray)
			...
			$this->objLemonAssessment->ResourceId = 15;
	...
	protected function btnSubmit_Click() {	
		...
		QApplication::Redirect(__SUBDIRECTORY__.'/assessments/lemonlovers/viewAssessment.php');
	}
...
NewLemonloversAssessmentForm::Run('NewLemonloversAssessmentForm');
?>