...
class GrouploversAggregationResultForm extends InstituteForm {
	...
	protected function Form_Create() {
		...
		foreach($this->groupArray as $objGroupAssessmentId) {
			...
			$groupArray = LemonloversAssessment::LoadArrayByGroupId($objGroupAssessment->Id);	
			foreach($groupArray as $objGroup) {
				...
				if(!$objGroup->L) {
					...
					$resultArray = LemonloversAssessmentResults::LoadArrayByAssessmentId($objGroup->Id);
		...
		$strResultsSummary = '<p>The table provides a summary of results for each person in the group. </p>'.
							...
							'<a target="_blank" href="'.__SUBDIRECTORY__.'/assessments/lemonlovers/groupIndividualImg.php/'.$strArgs.'"/>View Individual Results</a>';
		...
		$accordion = array('LEMON Results Summary','Group Aggregate Bar Chart', 'Group Aggregate Radar', 'Group First And Second Slices','Group Average Pie Chart','Group Normalized Chart',
						   'Group First Slice Pie Chart','Group By LEMON Type');
		$table = '<table class="lemonSummary">' .
					...
					'</tr>'.$summary.
					'</table>'.
					'<a target="_blank" href="'.__SUBDIRECTORY__.'/assessments/lemonlovers/exportToExcel.php/'.$strArgs.'"/>Export to Excel</a>';
		$content = array($table. $strResultsSummary,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupBarImg.php/'.$strArgs.'\' /> <br><br>'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemon/globalAverageImg.php\' width="50%" height="50%" />'.$strAggregateBar,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupRadarImg.php/'.$strArgs.'\' />'.$strAggregateRadar,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupFirstSecondImg.php/'.$strArgs.'\' />'.$strFirstSecond,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupPieImg.php/'.$strArgs.'\' />'.$strGroupAveragePie,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupNormalizedImg.php/'.$strArgs.'\' />'.$strNormalized,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupFirstSlicePieImg.php/'.$strArgs.'\' />'.
						  ...
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupByLemonType.php/0/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupByLemonType.php/1/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupByLemonType.php/2/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupByLemonType.php/3/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/groupByLemonType.php/4/'.$strArgs.'\' />'.$strGroupByLemonType);
        ...
        $this->dtgUsers->MetaAddEditLinkColumn('<?=__SUBDIRECTORY__.InstituteForm::DirAssessments."/lemonlovers/viewAssessment.php/".$_ITEM->Id ?>','<?= $_FORM->RenderName($_ITEM)?>','Name');		
	...
	public function chkSelected_Render(User $objUser, $intRow) {
		...
		$lemonArray = $objUser->GetLemonloversAssessmentArray();
	...
	public function btnSubmit_Click($strFormId, $strControlId, $strParameter) {
		...
		$content = array($table. $strResultsSummary,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50BarImg.php/'.$strArgs.'\' /> <br><br>'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/globalAverageImg.php\' width="50%" height="50%" />'.$strAggregateBar,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50RadarImg.php/'.$strArgs.'\' />'.$strAggregateRadar,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50FirstSecondImg.php/'.$strArgs.'\' />'.$strFirstSecond,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50PieImg.php/'.$strArgs.'\' />'.$strGroupAveragePie,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50NormalizedImg.php/'.$strArgs.'\' />'.$strNormalized,
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50FirstSlicePieImg.php/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/globalFirstImg.php/global \'>'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/globalFirstImg.php/gender/0 \'>'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/globalFirstImg.php/gender/1 \'>'.$strFirstPie,						 
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50ByLemonType.php/0/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50ByLemonType.php/1/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50ByLemonType.php/2/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50ByLemonType.php/3/'.$strArgs.'\' />'.
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/lemonlovers/group50ByLemonType.php/4/'.$strArgs.'\' />'.$strGroupByLemonType);
...
GrouploversAggregationResultForm::Run('GrouploversAggregationResultForm');
?>