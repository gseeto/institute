...
class GroupTenPAggregationResultForm extends InstituteForm {
	...
	protected function Form_Create() {
		...
		$groupArray = TenPAssessment::LoadArrayByGroupId($this->objGroupAssessment->Id);	
		...
		$content = array('<img src=\''.__SUBDIRECTORY__.'/assessments/tenp/groupSpiderImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/tenp/groupTitleGapImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/tenp/groupTenureGapImg.php/'.$strArgs.'\' />',
						  '<img src=\''.__SUBDIRECTORY__.'/assessments/tenp/groupCountryGapImg.php/'.$strArgs.'\' />');
        ...
        $this->dtgUsers->MetaAddEditLinkColumn('<?=__SUBDIRECTORY__.InstituteForm::DirAssessments."/tenp/viewAssessment.php/".$_ITEM->Id ?>','<?= $_FORM->RenderName($_ITEM)?>','Name');
	...
	public function chkSelected_Render(User $objUser, $intRow) {
		...
		$tenPArray = $objUser->GetTenPAssessmentArray();
...
GroupTenPAggregationResultForm::Run('GroupTenPAggregationResultForm');
?>