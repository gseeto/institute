...
class TenPGroupQuestions extends InstituteForm {
	...
	protected function btnSubmit_Click() {	
        ...
        $objGroupAssessment = GroupAssessmentList::Load($this->objTenPAssessment->GroupId);
        $objGroupAssessment->KeysLeft--;
        $objGroupAssessment->Save();
		QApplication::Redirect(__SUBDIRECTORY__.'/assessments/tenp/groupResults.php');
	}
...
TenPGroupQuestions::Run('TenPGroupQuestions');
?>