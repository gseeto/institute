...
class PGroupLoginForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {
		...
		if (!$objGroupAssessment) {
			...
			if ($objGroupAssessment->KeysLeft <= 0) {
				...
				QApplication::Redirect(__SUBDIRECTORY__.'/assessments/tenp/groupInfo.php/'.$objGroupAssessment->Id);
			}
		}
	}
...
PGroupLoginForm::Run('PGroupLoginForm');
?>