...
class TimeGroupLoginForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {
		...
		if (!$objGroupAssessment) {
			...
			if ($objGroupAssessment->KeysLeft <= 0) {
				...
				QApplication::Redirect(__SUBDIRECTORY__.'/assessments/time/groupInfo.php/'.$objGroupAssessment->Id);
			}
		}
	}
...
TimeGroupLoginForm::Run('TimeGroupLoginForm');
?>