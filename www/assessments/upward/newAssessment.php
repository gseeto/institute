...
class NewUpwardAssessmentForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {	
		...
		QApplication::Redirect(__SUBDIRECTORY__.'/assessments/upward/viewAssessment.php');
	}
...
NewUpwardAssessmentForm::Run('NewUpwardAssessmentForm');
?>