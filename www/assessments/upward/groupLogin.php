...
class UpwardGroupLoginForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {
		...
		if (!$objGroupAssessment) {
			...
			if ($objGroupAssessment->KeysLeft <= 0) {
				...
				QApplication::Redirect(__SUBDIRECTORY__.'/assessments/upward/groupInfo.php/'.$objGroupAssessment->Id);
			}
		}
	}
...
UpwardGroupLoginForm::Run('UpwardGroupLoginForm');
?>