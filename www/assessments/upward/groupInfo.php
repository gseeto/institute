...
class UpwardGroupInfoForm extends InstituteForm {
	...
	protected function btnSubmit_Click() {
		...
		if ($objLogin) {
			...
			QApplication::Redirect(__SUBDIRECTORY__.'/assessments/upward/groupQuestions.php');
		}
	...
	protected function btnLogin_Click() {
		...
		if ($objUser->IsResourceAssociated(Resource::Load(10))) {
			QApplication::Login($objLogin);
			QApplication::Redirect(__SUBDIRECTORY__.'/assessments/upward/groupQuestions.php/edit');
		} else {
	     	$objAssessment = new UpwardAssessment();
	     	$objAssessment->UserId = $objUser->Id;
	     	$objAssessment->ResourceId = 10; //Education 8-P Assessment - going to have to find a nicer way of doing this
...
UpwardGroupInfoForm::Run('UpwardGroupInfoForm');
?>