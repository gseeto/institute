...
class ViewSeasonalAssessmentForm extends InstituteForm {
	...
	protected function Form_Create() {			
		...
		if($intUserId) { //show the assessment specified
			...
			$this->lblIntroduction->Text = 'Seasonal Assessment for '.$objUser->FirstName. ' '.$objUser->LastName;
		} else { // show the user's assessment	
			$this->lblIntroduction->Text = 'Thank you for taking the Seasonal Assessment.
