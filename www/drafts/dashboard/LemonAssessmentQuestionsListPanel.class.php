<?php
	 ...
	 * list a collection of LemonAssessmentQuestions objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this LemonAssessmentQuestionsListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class LemonAssessmentQuestionsListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list LemonAssessmentQuestionses
		public $dtgLemonAssessmentQuestionses;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'LemonAssessmentQuestionsListPanel.tpl.php';
			...
			$this->dtgLemonAssessmentQuestionses->ItemsPerPage = 8;
			...
			$this->dtgLemonAssessmentQuestionses->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('LemonAssessmentQuestions');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new LemonAssessmentQuestionsEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new LemonAssessmentQuestionsEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
