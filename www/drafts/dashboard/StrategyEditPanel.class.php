<?php
	 ...
	 * @subpackage Drafts
	 */
	class StrategyEditPanel extends QPanel {
		...
		public $lstGiantsesAsGiant;
		public $lstSpheresesAsSphere;
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intId = null, $strControlId = null) {
			...
			$this->strTemplate = 'StrategyEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the StrategyMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctStrategy = StrategyMetaControl::Create($this, $intId);
