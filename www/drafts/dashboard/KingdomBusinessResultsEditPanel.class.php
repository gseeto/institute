<?php
	 ...
	 * @subpackage Drafts
	 */
	class KingdomBusinessResultsEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intId = null, $strControlId = null) {
			...
			$this->strTemplate = 'KingdomBusinessResultsEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the KingdomBusinessResultsMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctKingdomBusinessResults = KingdomBusinessResultsMetaControl::Create($this, $intId);
