<?php
	 ...
	 * 
	 */
	class RoleListPanel extends QPanel {
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'RoleListPanel.tpl.php';
			...
			$this->dtgRoles->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
		...
		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			...
			$objEditPanel = new RoleEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
