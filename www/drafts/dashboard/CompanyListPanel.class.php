<?php
	 ...
	 * 
	 */
	class CompanyListPanel extends QPanel {
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'CompanyListPanel.tpl.php';
			...
			$this->dtgCompanies->ItemsPerPage = 8;
			...
			$this->dtgCompanies->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
		...
		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			...
			$objEditPanel = new CompanyEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
