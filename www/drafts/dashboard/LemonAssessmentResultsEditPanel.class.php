<?php
	 ...
	 * @subpackage Drafts
	 */
	class LemonAssessmentResultsEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intId = null, $strControlId = null) {
			...
			$this->strTemplate = 'LemonAssessmentResultsEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the LemonAssessmentResultsMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctLemonAssessmentResults = LemonAssessmentResultsMetaControl::Create($this, $intId);
