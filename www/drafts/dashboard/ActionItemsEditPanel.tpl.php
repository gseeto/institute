<?php
	// This is the HTML template include file (.tpl.php) for action_itemsEditPanel.
...
?>
	<div id="formControls">
		...
		<?php $_CONTROL->txtAction->RenderWithName(); ?>

		<?php $_CONTROL->lstStrategy->RenderWithName(); ?>

		<?php $_CONTROL->lstScorecard->RenderWithName(); ?>

		<?php $_CONTROL->lstWhoObject->RenderWithName(); ?>

		<?php $_CONTROL->calWhen->RenderWithName(); ?>

		<?php $_CONTROL->lstStatusTypeObject->RenderWithName(); ?>
