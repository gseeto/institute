<?php
	...
	$strPageTitle = QApplication::Translate('Companies') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<div id="titleBar">
		...
		<h1><?php _t('Companies'); ?></h1>
	</div>

	<?php $this->dtgCompanies->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/company_edit.php"><?php _t('Create a New'); ?> <?php _t('Company');?></a>
	</p>
