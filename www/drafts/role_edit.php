<?php
	 ...
	 * RoleMetaControl class, which has meta-methods to help with
	 * easily creating/defining controls to modify the fields of a Role columns.
	 *
	 * Any display customizations and presentation-tier logic can be implemented
	 * here by overriding existing or implementing new methods, properties and variables.
	 * 
	 * NOTE: This file is overwritten on any code regenerations.  If you want to make
	 * permanent changes, it is STRONGLY RECOMMENDED to move both role_edit.php AND
	 * role_edit.tpl.php out of this Form Drafts directory.
	 *
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			$this->lblId = $this->mctRole->lblId_Create();
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/role_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// role_edit.tpl.php as the included HTML template file
