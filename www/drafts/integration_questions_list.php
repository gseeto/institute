<?php
	 ...
	 * IntegrationQuestionsDataGrid control which has meta-methods to help with
	 * easily creating/defining IntegrationQuestions columns.
	 *
	 * Any display customizations and presentation-tier logic can be implemented
	 * here by overriding existing or implementing new methods, properties and variables.
	 * 
	 * NOTE: This file is overwritten on any code regenerations.  If you want to make
	 * permanent changes, it is STRONGLY RECOMMENDED to move both integration_questions_list.php AND
	 * integration_questions_list.tpl.php out of this Form Drafts directory.
	 *
	 * @package My Application
	 * @subpackage Drafts
	 */
	class IntegrationQuestionsListForm extends QForm {
		// Local instance of the Meta DataGrid to list IntegrationQuestionses
		protected $dtgIntegrationQuestionses;
...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtgIntegrationQuestionses->ItemsPerPage = 20;

			// Use the MetaDataGrid functionality to add Columns for this datagrid

			// Create an Edit Column
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/integration_questions_edit.php';
			$this->dtgIntegrationQuestionses->MetaAddEditLinkColumn($strEditPageUrl, 'Edit', 'Edit');
	...
	// integration_questions_list.tpl.php as the included HTML template file
	IntegrationQuestionsListForm::Run('IntegrationQuestionsListForm');
?>