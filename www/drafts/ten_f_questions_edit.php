<?php
	 ...
	 * @subpackage Drafts
	 */
	class TenFQuestionsEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the TenFQuestionsMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctTenFQuestions = TenFQuestionsMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/ten_f_questions_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// ten_f_questions_edit.tpl.php as the included HTML template file
	TenFQuestionsEditForm::Run('TenFQuestionsEditForm');
?>