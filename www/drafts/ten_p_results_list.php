<?php
	 ...
	 * TenPResultsDataGrid control which has meta-methods to help with
	 * easily creating/defining TenPResults columns.
	 *
	 * Any display customizations and presentation-tier logic can be implemented
	 * here by overriding existing or implementing new methods, properties and variables.
	 * 
	 * NOTE: This file is overwritten on any code regenerations.  If you want to make
	 * permanent changes, it is STRONGLY RECOMMENDED to move both ten_p_results_list.php AND
	 * ten_p_results_list.tpl.php out of this Form Drafts directory.
	 *
	 * @package My Application
	 * @subpackage Drafts
	 */
	class TenPResultsListForm extends QForm {
		// Local instance of the Meta DataGrid to list TenPResultses
		protected $dtgTenPResultses;
...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$this->dtgTenPResultses->ItemsPerPage = 20;

			// Use the MetaDataGrid functionality to add Columns for this datagrid

			// Create an Edit Column
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/ten_p_results_edit.php';
			$this->dtgTenPResultses->MetaAddEditLinkColumn($strEditPageUrl, 'Edit', 'Edit');
	...
	// ten_p_results_list.tpl.php as the included HTML template file
	TenPResultsListForm::Run('TenPResultsListForm');
?>