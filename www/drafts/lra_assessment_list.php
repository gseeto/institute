<?php
	 ...
	 * LraAssessmentDataGrid control which has meta-methods to help with
	 * easily creating/defining LraAssessment columns.
	 *
	 * Any display customizations and presentation-tier logic can be implemented
	 * here by overriding existing or implementing new methods, properties and variables.
	 * 
	 * NOTE: This file is overwritten on any code regenerations.  If you want to make
	 * permanent changes, it is STRONGLY RECOMMENDED to move both lra_assessment_list.php AND
	 * lra_assessment_list.tpl.php out of this Form Drafts directory.
	 *
	 * @package My Application
	 * @subpackage Drafts
	 */
	class LraAssessmentListForm extends QForm {
...
//		protected function Form_Validate() {}
		...
		protected function Form_Create() {
			...
			$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/lra_assessment_edit.php';
			$this->dtgLraAssessments->MetaAddEditLinkColumn($strEditPageUrl, 'Edit', 'Edit');
	...
	// lra_assessment_list.tpl.php as the included HTML template file
	LraAssessmentListForm::Run('LraAssessmentListForm');
?>