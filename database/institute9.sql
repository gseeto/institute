...
ALTER TABLE `canned_action_item` ADD FOREIGN KEY strategy_id_idxfk_2 (`strategy_id`) REFERENCES `canned_strategy` (`id`);

ALTER TABLE `canned_kpi` ADD FOREIGN KEY strategy_id_idxfk_3 (`strategy_id`) REFERENCES `canned_strategy` (`id`);
