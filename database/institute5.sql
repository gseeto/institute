...
ALTER TABLE `lemon_assessment` ADD FOREIGN KEY resource_id_idxfk_4 (`resource_id`) REFERENCES `resource` (`id`);
...
ALTER TABLE `ten_f_assessment` ADD FOREIGN KEY resource_id_idxfk_5 (`resource_id`) REFERENCES `resource` (`id`);
