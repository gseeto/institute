...
ALTER TABLE ten_f_results ADD FOREIGN KEY question_id_idxfk_3 (question_id) REFERENCES ten_f_questions (id);

ALTER TABLE ten_f_results ADD FOREIGN KEY assessment_id_idxfk_3 (assessment_id) REFERENCES ten_f_assessment (id);

ALTER TABLE ten_p_questions ADD FOREIGN KEY category_id_idxfk_3 (category_id) REFERENCES category_type (id);

ALTER TABLE strategy_question_conditional ADD FOREIGN KEY question_id_idxfk_4 (question_id) REFERENCES ten_p_questions (id);
...
ALTER TABLE ten_p_results ADD FOREIGN KEY question_id_idxfk_5 (question_id) REFERENCES ten_p_questions (id);

CREATE INDEX assessment_id_idx ON ten_p_results(assessment_id);
ALTER TABLE ten_p_results ADD FOREIGN KEY assessment_id_idxfk_4 (assessment_id) REFERENCES ten_p_assessment (id);
...
ALTER TABLE integration_assessment ADD FOREIGN KEY user_id_idxfk (user_id) REFERENCES user (id);
...
ALTER TABLE action_items ADD FOREIGN KEY strategy_id_idxfk_5 (strategy_id) REFERENCES strategy (id);
...
ALTER TABLE action_items ADD FOREIGN KEY category_id_idxfk_4 (category_id) REFERENCES category_type (id);

ALTER TABLE action_items ADD FOREIGN KEY modified_by_idxfk_1 (modified_by) REFERENCES user (id);

ALTER TABLE kpis ADD FOREIGN KEY strategy_id_idxfk_6 (strategy_id) REFERENCES strategy (id);

ALTER TABLE kpis ADD FOREIGN KEY scorecard_id_idxfk_3 (scorecard_id) REFERENCES scorecard (id);

ALTER TABLE kpis ADD FOREIGN KEY modified_by_idxfk_2 (modified_by) REFERENCES user (id);

ALTER TABLE assessment_manager_assn ADD FOREIGN KEY user_id_idxfk_3 (user_id) REFERENCES user (id);
...
ALTER TABLE ten_p_assessment ADD FOREIGN KEY resource_status_id_idxfk_2 (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY company_id_idxfk_3 (company_id) REFERENCES company (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY resource_id_idxfk_5 (resource_id) REFERENCES resource (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY user_id_idxfk_6 (user_id) REFERENCES user (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY group_id_idxfk_2 (group_id) REFERENCES group_assessment_list (id);
...
ALTER TABLE lemon_assessment ADD FOREIGN KEY user_id_idxfk_8 (user_id) REFERENCES user (id);
