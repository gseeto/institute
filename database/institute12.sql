...
ALTER TABLE canned_action_item ADD FOREIGN KEY strategy_id_idxfk (strategy_id) REFERENCES canned_strategy (id);

ALTER TABLE canned_kpi ADD FOREIGN KEY strategy_id_idxfk_1 (strategy_id) REFERENCES canned_strategy (id);
...
ALTER TABLE seasonal_questions ADD FOREIGN KEY category_id_idxfk_2 (category_id) REFERENCES seasonal_category_type (id);

ALTER TABLE seasonal_results ADD FOREIGN KEY question_id_idxfk_3 (question_id) REFERENCES seasonal_questions (id);

ALTER TABLE seasonal_results ADD FOREIGN KEY assessment_id_idxfk_3 (assessment_id) REFERENCES seasonal_assessment (id);
...
ALTER TABLE ten_f_questions ADD FOREIGN KEY category_id_idxfk_3 (category_id) REFERENCES f_category_type (id);

ALTER TABLE ten_f_results ADD FOREIGN KEY question_id_idxfk_4 (question_id) REFERENCES ten_f_questions (id);

ALTER TABLE ten_f_results ADD FOREIGN KEY assessment_id_idxfk_4 (assessment_id) REFERENCES ten_f_assessment (id);

ALTER TABLE ten_p_questions ADD FOREIGN KEY category_id_idxfk_4 (category_id) REFERENCES category_type (id);

ALTER TABLE strategy_question_conditional ADD FOREIGN KEY question_id_idxfk_5 (question_id) REFERENCES ten_p_questions (id);
...
ALTER TABLE ten_p_results ADD FOREIGN KEY question_id_idxfk_6 (question_id) REFERENCES ten_p_questions (id);

CREATE INDEX assessment_id_idx ON ten_p_results(assessment_id);
ALTER TABLE ten_p_results ADD FOREIGN KEY assessment_id_idxfk_5 (assessment_id) REFERENCES ten_p_assessment (id);

ALTER TABLE time_results ADD FOREIGN KEY assessment_id_idxfk_6 (assessment_id) REFERENCES time_assessment (id);
...
ALTER TABLE time_assessment ADD FOREIGN KEY resource_status_id_idxfk (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE time_assessment ADD FOREIGN KEY resource_id_idxfk_2 (resource_id) REFERENCES resource (id);

ALTER TABLE time_assessment ADD FOREIGN KEY user_id_idxfk (user_id) REFERENCES user (id);

ALTER TABLE time_assessment ADD FOREIGN KEY group_id_idxfk (group_id) REFERENCES group_assessment_list (id);
...
ALTER TABLE action_items ADD FOREIGN KEY category_id_idxfk_5 (category_id) REFERENCES category_type (id);
...
ALTER TABLE seasonal_assessment ADD FOREIGN KEY resource_status_id_idxfk_3 (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE seasonal_assessment ADD FOREIGN KEY resource_id_idxfk_6 (resource_id) REFERENCES resource (id);

ALTER TABLE seasonal_assessment ADD FOREIGN KEY user_id_idxfk_7 (user_id) REFERENCES user (id);

ALTER TABLE seasonal_assessment ADD FOREIGN KEY group_id_idxfk_3 (group_id) REFERENCES group_assessment_list (id);
...
ALTER TABLE ten_p_assessment ADD FOREIGN KEY company_id_idxfk_4 (company_id) REFERENCES company (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY resource_id_idxfk_8 (resource_id) REFERENCES resource (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY user_id_idxfk_9 (user_id) REFERENCES user (id);
