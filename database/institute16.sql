...
ALTER TABLE postventure_questions ADD FOREIGN KEY category_id_idxfk_3 (category_id) REFERENCES category_type (id);

CREATE INDEX question_id_idx ON postventure_results (question_id);
ALTER TABLE postventure_results ADD FOREIGN KEY question_id_idxfk_4 (question_id) REFERENCES postventure_questions (id);

CREATE INDEX assessment_id_idx ON postventure_results (assessment_id);
ALTER TABLE postventure_results ADD FOREIGN KEY assessment_id_idxfk_4 (assessment_id) REFERENCES postventure_assessment (id);
...
ALTER TABLE seasonal_questions ADD FOREIGN KEY category_id_idxfk_4 (category_id) REFERENCES seasonal_category_type (id);

ALTER TABLE seasonal_results ADD FOREIGN KEY question_id_idxfk_5 (question_id) REFERENCES seasonal_questions (id);

ALTER TABLE seasonal_results ADD FOREIGN KEY assessment_id_idxfk_5 (assessment_id) REFERENCES seasonal_assessment (id);
...
ALTER TABLE ten_f_questions ADD FOREIGN KEY category_id_idxfk_5 (category_id) REFERENCES f_category_type (id);

ALTER TABLE ten_f_results ADD FOREIGN KEY question_id_idxfk_6 (question_id) REFERENCES ten_f_questions (id);

ALTER TABLE ten_f_results ADD FOREIGN KEY assessment_id_idxfk_6 (assessment_id) REFERENCES ten_f_assessment (id);

ALTER TABLE ten_p_questions ADD FOREIGN KEY category_id_idxfk_6 (category_id) REFERENCES category_type (id);

ALTER TABLE strategy_question_conditional ADD FOREIGN KEY question_id_idxfk_7 (question_id) REFERENCES ten_p_questions (id);
...
ALTER TABLE ten_p_results ADD FOREIGN KEY question_id_idxfk_8 (question_id) REFERENCES ten_p_questions (id);

CREATE INDEX assessment_id_idx ON ten_p_results (assessment_id);
ALTER TABLE ten_p_results ADD FOREIGN KEY assessment_id_idxfk_7 (assessment_id) REFERENCES ten_p_assessment (id);

ALTER TABLE time_results ADD FOREIGN KEY assessment_id_idxfk_8 (assessment_id) REFERENCES time_assessment (id);

ALTER TABLE upward_questions ADD FOREIGN KEY category_id_idxfk_7 (category_id) REFERENCES upward_category_type (id);

ALTER TABLE upward_results ADD FOREIGN KEY question_id_idxfk_9 (question_id) REFERENCES upward_questions (id);

ALTER TABLE upward_results ADD FOREIGN KEY assessment_id_idxfk_9 (assessment_id) REFERENCES upward_assessment (id);
...
ALTER TABLE postventure_assessment ADD FOREIGN KEY resource_status_id_idxfk (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE postventure_assessment ADD FOREIGN KEY resource_id_idxfk_2 (resource_id) REFERENCES resource (id);

ALTER TABLE postventure_assessment ADD FOREIGN KEY user_id_idxfk (user_id) REFERENCES user (id);

ALTER TABLE postventure_assessment ADD FOREIGN KEY group_id_idxfk (group_id) REFERENCES group_assessment_list (id);

ALTER TABLE scorecard_user_assn ADD FOREIGN KEY user_id_idxfk_1 (user_id) REFERENCES user (id);

ALTER TABLE scorecard_user_assn ADD FOREIGN KEY scorecard_id_idxfk (scorecard_id) REFERENCES scorecard (id);

ALTER TABLE integration_assessment ADD FOREIGN KEY resource_status_id_idxfk_1 (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE integration_assessment ADD FOREIGN KEY resource_id_idxfk_3 (resource_id) REFERENCES resource (id);

ALTER TABLE integration_assessment ADD FOREIGN KEY user_id_idxfk_2 (user_id) REFERENCES user (id);

ALTER TABLE integration_assessment ADD FOREIGN KEY group_id_idxfk_1 (group_id) REFERENCES group_assessment_list (id);
...
ALTER TABLE ten_f_assessment ADD FOREIGN KEY resource_status_id_idxfk_2 (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE ten_f_assessment ADD FOREIGN KEY resource_id_idxfk_4 (resource_id) REFERENCES resource (id);

ALTER TABLE ten_f_assessment ADD FOREIGN KEY user_id_idxfk_3 (user_id) REFERENCES user (id);

ALTER TABLE ten_f_assessment ADD FOREIGN KEY group_id_idxfk_2 (group_id) REFERENCES group_assessment_list (id);
...
ALTER TABLE action_items ADD FOREIGN KEY category_id_idxfk_8 (category_id) REFERENCES category_type (id);
...
ALTER TABLE resource_user_assn ADD FOREIGN KEY resource_id_idxfk_5 (resource_id) REFERENCES resource (id);

ALTER TABLE resource_user_assn ADD FOREIGN KEY user_id_idxfk_4 (user_id) REFERENCES user (id);

ALTER TABLE lra_assessment ADD FOREIGN KEY resource_status_id_idxfk_3 (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE lra_assessment ADD FOREIGN KEY resource_id_idxfk_6 (resource_id) REFERENCES resource (id);

ALTER TABLE lra_assessment ADD FOREIGN KEY user_id_idxfk_5 (user_id) REFERENCES user (id);

ALTER TABLE lra_assessment ADD FOREIGN KEY group_id_idxfk_3 (group_id) REFERENCES group_assessment_list (id);

ALTER TABLE company_user_assn ADD FOREIGN KEY company_id_idxfk_2 (company_id) REFERENCES company (id);

ALTER TABLE company_user_assn ADD FOREIGN KEY user_id_idxfk_6 (user_id) REFERENCES user (id);

ALTER TABLE assessment_manager_assn ADD FOREIGN KEY user_id_idxfk_7 (user_id) REFERENCES user (id);
...
ALTER TABLE kingdom_business_assessment ADD FOREIGN KEY resource_id_idxfk_7 (resource_id) REFERENCES resource (id);

ALTER TABLE kingdom_business_assessment ADD FOREIGN KEY user_id_idxfk_8 (user_id) REFERENCES user (id);

ALTER TABLE kingdom_business_assessment ADD FOREIGN KEY resource_status_id_idxfk_4 (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE kingdom_business_assessment ADD FOREIGN KEY group_id_idxfk_4 (group_id) REFERENCES group_assessment_list (id);
...
ALTER TABLE seasonal_assessment ADD FOREIGN KEY resource_id_idxfk_8 (resource_id) REFERENCES resource (id);

ALTER TABLE seasonal_assessment ADD FOREIGN KEY user_id_idxfk_9 (user_id) REFERENCES user (id);

ALTER TABLE seasonal_assessment ADD FOREIGN KEY group_id_idxfk_5 (group_id) REFERENCES group_assessment_list (id);

ALTER TABLE lemon_assessment ADD FOREIGN KEY user_id_idxfk_10 (user_id) REFERENCES user (id);

ALTER TABLE lemon_assessment ADD FOREIGN KEY company_id_idxfk_4 (company_id) REFERENCES company (id);

ALTER TABLE lemon_assessment ADD FOREIGN KEY resource_id_idxfk_9 (resource_id) REFERENCES resource (id);

ALTER TABLE lemon_assessment ADD FOREIGN KEY group_id_idxfk_6 (group_id) REFERENCES group_assessment_list (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY resource_status_id_idxfk_6 (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY company_id_idxfk_5 (company_id) REFERENCES company (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY resource_id_idxfk_10 (resource_id) REFERENCES resource (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY user_id_idxfk_11 (user_id) REFERENCES user (id);

ALTER TABLE ten_p_assessment ADD FOREIGN KEY group_id_idxfk_7 (group_id) REFERENCES group_assessment_list (id);

ALTER TABLE time_assessment ADD FOREIGN KEY resource_status_id_idxfk_7 (resource_status_id) REFERENCES resource_status (id);

ALTER TABLE time_assessment ADD FOREIGN KEY resource_id_idxfk_11 (resource_id) REFERENCES resource (id);

ALTER TABLE time_assessment ADD FOREIGN KEY user_id_idxfk_12 (user_id) REFERENCES user (id);

ALTER TABLE time_assessment ADD FOREIGN KEY group_id_idxfk_8 (group_id) REFERENCES group_assessment_list (id);

ALTER TABLE upward_assessment ADD FOREIGN KEY user_id_idxfk_13 (user_id) REFERENCES user (id);

ALTER TABLE upward_assessment ADD FOREIGN KEY group_id_idxfk_9 (group_id) REFERENCES group_assessment_list (id);
