...
ALTER TABLE upward_assessment ADD FOREIGN KEY user_id_idxfk (user_id) REFERENCES user (id);

ALTER TABLE upward_assessment ADD FOREIGN KEY group_id_idxfk (group_id) REFERENCES group_assessment_list (id);
