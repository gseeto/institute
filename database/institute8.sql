...
ALTER TABLE `canned_strategy` ADD FOREIGN KEY category_type_id_idxfk_1 (`category_type_id`) REFERENCES `category_type` (`id`);

ALTER TABLE `canned_action_item` ADD FOREIGN KEY strategy_id_idxfk_4 (`strategy_id`) REFERENCES `canned_strategy` (`id`);

ALTER TABLE `canned_kpi` ADD FOREIGN KEY strategy_id_idxfk_5 (`strategy_id`) REFERENCES `canned_strategy` (`id`);

ALTER TABLE `strategy_question_conditional` ADD FOREIGN KEY question_id_idxfk (`question_id`) REFERENCES `ten_p_questions` (`id`);

ALTER TABLE `strategy_question_conditional` ADD FOREIGN KEY strategy_id_idxfk_6 (`strategy_id`) REFERENCES `canned_strategy` (`id`);
...
ALTER TABLE `group_assessment_list` ADD FOREIGN KEY resource_id_idxfk_2 (`resource_id`) REFERENCES `resource` (`id`);
