...
ALTER TABLE `ten_p_questions` ADD FOREIGN KEY category_id_idxfk (`category_id`) REFERENCES `category_type` (`id`);
...
ALTER TABLE `ten_f_questions` ADD FOREIGN KEY category_id_idxfk_2 (`category_id`) REFERENCES `f_category_type` (`id`);
...
ALTER TABLE `strategy_question_conditional` ADD FOREIGN KEY question_id_idxfk (`question_id`) REFERENCES `ten_p_questions` (`id`);

ALTER TABLE `strategy_question_conditional` ADD FOREIGN KEY strategy_id_idxfk_2 (`strategy_id`) REFERENCES `canned_strategy` (`id`);
...
ALTER TABLE `group_assessment_list` ADD FOREIGN KEY resource_id_idxfk_1 (`resource_id`) REFERENCES `resource` (`id`);
...
ALTER TABLE `strategy_giant_assn` ADD FOREIGN KEY strategy_id_idxfk_3 (`strategy_id`) REFERENCES `strategy` (`id`);

ALTER TABLE `strategy_giant_assn` ADD FOREIGN KEY giant_id_idxfk (`giant_id`) REFERENCES `giants` (`id`);

ALTER TABLE `strategy_sphere_assn` ADD FOREIGN KEY strategy_id_idxfk_4 (`strategy_id`) REFERENCES `strategy` (`id`);
...
ALTER TABLE `action_items` ADD FOREIGN KEY category_id_idxfk_3 (`category_id`) REFERENCES `category_type` (`id`);
...
ALTER TABLE `resource_user_assn` ADD FOREIGN KEY resource_id_idxfk_2 (`resource_id`) REFERENCES `resource` (`id`);
...
ALTER TABLE `ten_p_assessment` ADD FOREIGN KEY resource_id_idxfk_3 (`resource_id`) REFERENCES `resource` (`id`);

ALTER TABLE `ten_p_assessment` ADD FOREIGN KEY user_id_idxfk_3 (`user_id`) REFERENCES `user` (`id`);

ALTER TABLE `ten_p_assessment` ADD FOREIGN KEY group_id_idxfk (`group_id`) REFERENCES `group_assessment_list` (`id`);

CREATE INDEX `question_id_idx` ON `ten_p_results`(`question_id`);
ALTER TABLE `ten_p_results` ADD FOREIGN KEY question_id_idxfk_1 (`question_id`) REFERENCES `ten_p_questions` (`id`);
...
ALTER TABLE `kingdom_business_assessment` ADD FOREIGN KEY resource_id_idxfk_4 (`resource_id`) REFERENCES `resource` (`id`);
...
ALTER TABLE `kingdom_business_assessment` ADD FOREIGN KEY group_id_idxfk_1 (`group_id`) REFERENCES `group_assessment_list` (`id`);

ALTER TABLE `kingdom_business_results` ADD FOREIGN KEY question_id_idxfk_2 (`question_id`) REFERENCES `kingdom_business_questions` (`id`);
...
ALTER TABLE `lemon_assessment` ADD FOREIGN KEY user_id_idxfk_5 (`user_id`) REFERENCES `user` (`id`);

ALTER TABLE `lemon_assessment` ADD FOREIGN KEY company_id_idxfk_5 (`company_id`) REFERENCES `company` (`id`);

ALTER TABLE `lemon_assessment` ADD FOREIGN KEY resource_id_idxfk_5 (`resource_id`) REFERENCES `resource` (`id`);

ALTER TABLE `lemon_assessment` ADD FOREIGN KEY group_id_idxfk_2 (`group_id`) REFERENCES `group_assessment_list` (`id`);

ALTER TABLE `lemon_assessment_results` ADD FOREIGN KEY question_id_idxfk_3 (`question_id`) REFERENCES `lemon_assessment_questions` (`id`);
...
ALTER TABLE `ten_f_assessment` ADD FOREIGN KEY resource_id_idxfk_6 (`resource_id`) REFERENCES `resource` (`id`);

ALTER TABLE `ten_f_assessment` ADD FOREIGN KEY user_id_idxfk_6 (`user_id`) REFERENCES `user` (`id`);

ALTER TABLE `ten_f_assessment` ADD FOREIGN KEY group_id_idxfk_3 (`group_id`) REFERENCES `group_assessment_list` (`id`);

ALTER TABLE `ten_f_results` ADD FOREIGN KEY question_id_idxfk_4 (`question_id`) REFERENCES `ten_f_questions` (`id`);

ALTER TABLE `ten_f_results` ADD FOREIGN KEY assessment_id_idxfk_3 (`assessment_id`) REFERENCES `ten_f_assessment` (`id`);
