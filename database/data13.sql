...
--
-- Host: localhost
-- Generation Time: Mar 25, 2013 at 01:17 PM
...
('bobama', 'bobama', 18, 4),
('gbush', 'gbush', 19, 4),
('student', 'student', 20, 4),
('akao', 'akao', 21, 4),
('thor', 'thor', 22, 4),
('alincoln', 'alincoln', 23, 4),
('djohnson', 'djohnson', 24, 3),
('jcarter', 'jcarter', 25, 4),
('llam', 'llam', 26, 4),
('bilbo', 'bilbo', 27, 4),
('frodo', 'frodo', 28, 4),
('Smair_generated', 'Smair_generated', 32, 4);
...
(2, 3, 'Brett', 'Johnson', 'brettj@inst.net', 1, 9, NULL, NULL, NULL, NULL),
(3, 5, 'Linda', 'Widjaja', 'lwidjaja@inst.net', 0, 10, NULL, NULL, NULL, NULL),
(4, 6, 'Linh', 'Ly', 'linhl@inst.net', 0, 9, NULL, NULL, NULL, NULL),
(5, 7, 'Dena', 'Andrews', 'denaa@inst.net', 0, 1, NULL, NULL, NULL, NULL),
(6, 8, 'Lyn', 'Johnson', 'lynj@inst.net', 0, 9, NULL, NULL, NULL, NULL),
(7, 9, 'Kim', 'Wilson', 'kimw@inst.net', 0, 9, NULL, NULL, NULL, NULL),
(8, 10, 'Bruce', 'Wayne', 'batman@gmail.com', 1, 9, NULL, NULL, NULL, NULL),
(9, 11, 'Clark', 'Kent', 'superman@gmail.com', 1, 9, NULL, NULL, NULL, NULL),
(10, 12, 'Diana', 'Prince', 'wonderwoman@yahoo.com', 0, 9, NULL, NULL, NULL, NULL),
(11, 13, 'Mike', 'Cheves', '', 1, 9, NULL, NULL, NULL, NULL),
(12, 14, 'Brett', 'Kenny', 'kenny@gmail.com', 1, 9, NULL, NULL, NULL, NULL),
(13, 15, 'Bill', 'Bright', 'bright@gmail.com', 1, 9, NULL, NULL, NULL, NULL),
...
(18, 20, 'a', 'student', 'student@gmail.com', 1, 9, NULL, 3, 1, NULL),
(19, 21, 'Angela', 'Kao', 'a.kao@gmail.com', 0, 9, NULL, 1, 1, NULL),
(20, 22, 'Donald', 'Blake', 'thor@gmail.com', 1, 19, NULL, 1, 1, NULL),
(21, 23, 'Abraham', 'Lincoln', 'abe@inst.net', 1, 44, NULL, 1, 3, NULL),
(22, 24, 'Doug', 'Johnson', 'doug@journeytools.co.za', 1, 17, NULL, 1, 1, NULL),
(23, 25, 'Jimmy', 'Carter', 'jcarter@inst.net', 1, 18, NULL, 2, 1, NULL),
(24, 26, 'Larry', 'Lam', 'llam@inst.net', 1, 7, NULL, 1, 3, NULL),
(25, 27, 'Bilbo', 'Baggins', 'bilbo.baggins@inst.net', 1, 17, NULL, 2, 2, NULL),
(26, 28, 'Frodo', 'Baggins', 'bilbo.baggins@inst.net', 1, 17, NULL, 2, 2, NULL),
(29, 32, 'Rami', 'Smair', 'abulreem007@yahoo.com', NULL, 9, NULL, NULL, 1, NULL);
UNLOCK TABLES;
--
...
(7, 'I stuffed that one up a bit. test', 1, 1, 1, 1, 1, '2013-02-13 09:02:14'),
...
(32, 'Expand our current partnering relationships to include additional HOPs that will further the purpose of Transforming Society. add something.\nAnd yet something more', 1, 1, 1, 5, 1, '2013-02-23 21:09:36'),
...
(34, 'Add a new action item for purpose cause you stuffed the last one up.', 7, 1, 2, '2011-06-08', 3, 'Put some sort of stuff in here\n', 1, 1, 1, '2013-02-23 20:51:09'),
(35, 'Refine positioning statement based on ramifications of refined purpose', 7, 1, 2, '2012-01-09', NULL, 'put a new comment in here', 1, 2, 1, '2013-02-23 20:24:17'),
(38, 'Update Who We Are Booklets to ensure they reflect our latest thinking and direction.\nmake a change', 8, 1, 1, '2012-06-17', NULL, 'Don''t print more booklets until done, please. Thanks', 1, 1, 1, '2013-02-23 20:09:23'),
(39, 'Add evaluations for Values and Foundational Principles to Home Office staff annual review template.', 8, 1, 1, '2012-06-01', NULL, 'completed - can this be removed?<br />\nBJ: reviews not yet implemented. Leave in.', 1, 2, 1, '2013-02-23 20:09:25'),
(40, 'Include evaluations for Values and Foundational Principles in leadership readiness evaluation.', 8, 1, 1, '2012-05-24', NULL, 'I think we need a re-emphasis on leadership development in 2012. This will come up again as a tool in this process. (bj)', 1, 3, 1, '2013-02-23 20:09:28'),
(41, 'Utilize Scorecard robustly to ensure that we implement our strategies consistent with Purpose.', 8, 1, NULL, '2012-01-30', NULL, 'We will be checking the scorecard each week, adding functionality, and seeing how it impacts our behavior.', 1, 4, 1, '2013-02-13 07:54:29'),
...
(244, 'Identify through relationship, prayer and interaction potential HOPs in various cities and nations. Work with Pete Stofle to zero  in on ONE city that is open.\nand make this different too\n', 32, 1, NULL, '2012-04-17', NULL, 'Portland (Christian Chamber, Vicki Norris)<br />\nGig Harbor (John Anderson)', 5, 1, 1, '2013-02-23 20:51:57'),
...
(270, 'Develop and maintain a mindmap of Responsibilities and people.', 36, 1, NULL, '2013-01-09', NULL, 'KIm; we need to jump back on Roles & Responsibilities', 7, 1, 1, '2013-03-02 06:45:31'),
(271, 'Write job descriptions according to responsibilities and needs.  ', 36, 1, NULL, '2012-03-20', 3, 'HOT to complete for themselves via Mind Map.<br />\nBJ - Drafted, under review by KW', 7, 2, 1, '2013-03-02 10:16:51'),
(272, 'Identify and publish functions and responsibilities that can be redeployed from the HOT to alumni...Identify the functions that must be handled by non-traveling staff/people, such as finances, admin, reporting, IT, phones.', 36, 1, 1, '2013-03-18', NULL, 'same as S1 A5', 7, 3, 1, '2013-03-02 10:17:06'),
(273, 'Identify staff members to recruit & oversee volunteers for each unfilled responsibility - ensure responsibilities are tied in with the volunteers growth path and calling ', 36, 1, 2, '2012-02-29', 2, 'and the HOT', 7, 4, 1, '2013-03-02 06:45:58'),
(274, 'Continuously pray in people to fill gaps.', 36, 1, NULL, '2013-03-28', NULL, 'and HOT.<br />\nDuring Wednesday prayer meetings<br />\nreoccuring', 7, 5, 1, '2013-03-02 10:17:19'),
...
(554, 'New action item', 7, 1, NULL, NULL, 1, NULL, 1, 3, 1, '2013-02-13 07:26:49');
...
(1, 50, 43, 5, 'lemon', 'Test the lemon group assessments'),
(2, 20, 20, 5, 'extraTest', 'adding an additional lemon group test'),
(3, 20, 17, 2, 'TenPTest', 'Testing the 10-P group assessments'),
(4, 14, 9, 3, 'repBiz2013Q1', 'key code for trainees'),
(5, 5, 3, 4, 'kingdom', 'kingdom test'),
(7, NULL, NULL, 5, 'test', NULL);
...
(10, 7, 1, 4, ' All of our home office staff (including remotes) can state and explain our Purpose.', NULL, 'Given that things spring from a spoken word, I have added this as a KPI.jhjhghjg', 1, '2013-02-13 09:26:08'),
...
(60, 32, 1, 1, 'Our partnerships are providing positive ROI\nModify a KPI.\n', NULL, '(Bethel is driving book sales & informal PR.)\nAdd something', 1, '2013-02-23 21:32:28'),
...
(176, 7, 1, 0, 'New KPI', 2, NULL, 1, '2013-02-13 09:26:17');
...
--
-- Table structure for table `integration_questions`
--

CREATE TABLE IF NOT EXISTS `integration_questions` (
...
--
-- Dumping data for table `integration_questions`
--

INSERT INTO `integration_questions` (`id`, `count`, `text`, `category_id`, `invert`) VALUES
(1, 1, 'It''s my goal to live a well-balanced life.', 2, 1),
(2, 2, 'I work to make money.', 3, 1),
(3, 3, 'Gifts to charities are more spiritual than giving ...', 7, 1),
(4, 4, 'My main meaning in life is found outside of work.', 2, 1),
(5, 5, 'My job is to see what God is doing and join him in...', 6, 0),
(6, 6, 'I work because work is inherently good.', 3, 0),
(7, 7, 'My ministry is mainly in my home.', 4, 1),
(8, 8, 'When I have excess I should give it away.', 7, 1),
(9, 9, 'I aim to do everything in moderation.', 2, 1),
(10, 10, 'My identity stems from my work.', 1, 1),
(11, 11, 'Once I have passed certain milestones I will focus on my calling.', 5, 1),
(12, 12, 'I hope for the best and plan for the worst.', 6, 1),
(13, 13, 'Business is business, and ministry is ministry, so they should be kept separate.', 6, 1),
(14, 14, 'I work to earn money to give to church ministers.', 3, 1),
(15, 15, 'My most effective ministry happens through my work.', 4, 0),
(16, 16, 'I take time off from work to do ministry/service.', 2, 1),
(17, 17, 'My ministry happens at church.', 4, 1),
(18, 18, 'I invest in my own calling.', 7, 0),
(19, 19, 'I spend a good percentage of time on my calling.', 5, 0),
(20, 20, 'My identity is rooted in God''s love for me.', 1, 0),
(21, 21, 'Financial margin is a prerequisite to following my calling', 5, 1),
(22, 22, 'I work to get finances to fund my ministry.', 3, 1),
(23, 23, 'Most of my ministry happens at work.', 4, 0),
(24, 24, 'I have deliberately connected my work and God''s glory', 1, 0),
(25, 25, 'My own effort is the primary determinant of my success.', 6, 1),
(26, 26, 'My main purpose is to portray the character and attributes of God.', 5, 0),
(27, 27, 'I am comfortable giving to organizations, including businesses, that minister effectively.	', 4, 0),
(28, 28, 'I am clear about my calling.', 5, 0),
(29, 29, 'I love my work.', 3, 0),
(30, 30, 'I am at peace with my family of origin.', 1, 0),
(31, 31, 'I put boundaries around my family life, keeping it separate from work.', 2, 1),
(32, 32, 'It is better to give to a church than invest in a business.', 7, 1),
(33, 33, 'I exhibit few signs of insecurity.', 1, 0),
(34, 34, 'Everything is God''s.', 6, 0),
(35, 35, 'Generating wealth is part of my Biblical mandate.', 7, 0);

--
-- Table structure for table `seasonal_questions`
--

CREATE TABLE IF NOT EXISTS `seasonal_questions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `count` int(11) DEFAULT NULL,
  `text` varchar(514) DEFAULT NULL,
  `category_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `seasonal_questions`
--

INSERT INTO `seasonal_questions` (`id`, `count`, `text`, `category_id`, `invert`) VALUES
(1, 1, 'I have people around me who encourage me to try new things.', 1, 0),
(2, 2, 'I''m willing to hear from God in different ways.', 3, 0),
(3, 3, 'My work reflects the character or nature of God.', 4, 0),
(4, 4, 'I''ve experienced or am currently experiencing times of transition, where I feel uprooted.', 7, 0),
(5, 5, 'Spirit is good, flesh is bad.', 6, 1),
(6, 6, 'My relationship with God is of great importance.', 2, 0),
(7, 7, 'I obey immediately whenever God tells me to do something.', 3, 0),
(8, 8, 'I am well aware of my gifts.', 1, 0),
(9, 9, 'Character is more important than results.', 5, 0),
(10, 10, 'I spend time honing my skills.', 4, 0),
(11, 11, 'There are times when I''ve felt the need to say ''no'' more than ''yes''.', 7, 0),
(12, 12, 'I need to focus on career first before finding a spouse.', 6, 1),
(13, 13, 'God wants to bless me with good things.', 2, 0),
(14, 14, 'God speaks to me in many different ways.', 3, 0),
(15, 15, 'I have a tendency to procrastinate.', 3, 1),
(16, 16, 'I am very competent at what I do.', 4, 0),
(17, 17, 'I enjoy my work and always aim for excellence.', 4, 0),
(18, 18, 'I need to identify my calling before choosing a spouse.', 6, 1),
(19, 19, 'There are times in my life when God seems more silent than usual.', 7, 0),
(20, 20, 'I have a healthy opinion of myself.', 1, 0),
(21, 21, 'When bad things happen the first thing I do is turn to God.', 2, 0),
(22, 22, 'God only speaks to me through his Word.', 3, 1),
(23, 23, 'Many of my competencies are based on foundational truths found in scripture.', 4, 0),
(24, 24, 'I have more of an eagerness to know Jesus than to have answers about him.', 7, 0),
(25, 25, 'A spouse limits my effectiveness for God.', 6, 1),
(26, 26, 'My actions reflect God''s sovereignty.', 2, 0),
(27, 27, 'I am willing to try new things to develop new skills.', 1, 0),
(28, 28, 'When I encounter pain, my first response is to see how God can use this for good.', 5, 0),
(29, 29, 'The end justifies the means.', 5, 1),
(30, 30, 'There is a soul mate out there for me. I just have to find him/her.', 6, 1),
(31, 31, 'I have been through experiences that, while difficult, have grounded me in God.', 7, 0),
(32, 32, 'I have been strengthened by trying circumstances in the past.', 5, 0),
(33, 33, 'I ask God more often for what he wants rather than for what I want.', 3, 0),
(34, 34, 'When I do the right thing but still get a wrong result, I can get bitter about it.', 5, 1),
(35, 35, 'I''m willing to take risks.', 2, 0);

--
-- Dumping data for table `lra_questions`
--

INSERT INTO `lra_questions` (`id`, `count`, `text`, `category_id`, `invert`) VALUES
(1, 1, 'I am in agreement with the purpose of the organization.', 1, 0),
(2, 2, 'The purpose of the organization is inspiring.', 1, 0),
(3, 3, 'I see the connection between what I do on a daily basis and the purpose of the organization', 1, 0),
(4, 4, 'The purpose of the organization is clear to the employees', 1, 0),
(5, 5, 'The employees of the organization are motivated by the purpose', 1, 0),
(6, 6, 'The efforts of the people I lead is directly related to the purpose of the organization.', 1, 0),
(7, 7, 'I believe in the value of the products of the organization and my department.', 2, 0),
(8, 8, 'I feel committed towards the creation of new products to achieve future purposes of the organization', 2, 0),
(9, 9, 'I am able to get the products to the market.', 2, 0),
(10, 10, 'Everyone understands the worth of the products of the organization.', 2, 0),
(11, 11, 'The sense of commitment to the products of the organization is high', 2, 0),
(12, 12, 'Employees are empowered to create new products.', 2, 0),
(13, 13, 'I understand my organization’s target audience.', 3, 0),
(14, 14, 'I project a positive image of the organization.', 3, 0),
(15, 15, 'It''s worth making the effort to differentiate the organization from our competitors.', 3, 0),
(16, 16, 'The staff knows the target audience of the organization.', 3, 0),
(17, 17, 'People feel proud to represent the organization.', 3, 0),
(18, 18, 'The quality of work distinguishes our people from our competitors.', 3, 0),
(19, 19, 'I understand the importance of establishing the presence of the organization.', 4, 0),
(20, 20, 'This is a really good organization to be associated with', 4, 0),
(21, 21, 'A lot of my effort goes into establishing the presence of the organization in the minds and hearts of people', 4, 0),
(22, 22, 'The team knows how to make the organization known.', 4, 0),
(23, 23, 'People feel excited about being a part of the organization.', 4, 0),
(24, 24, 'Everyone plays a significant part in making the organization known', 4, 0),
(25, 25, 'I''m aware of the individuals and groups who could help our organization to attain its goals.', 5, 0),
(26, 26, 'I feel a sense of commitment to partner with others who will better achieve our corporate purpose.', 5, 0),
(27, 27, 'I expend the resources necessary for building relationships with others who support and advance the purpose of the organization.', 5, 0),
(28, 28, 'People are informed about how to find good partners.', 5, 0),
(29, 29, 'The people I lead feel positive about our partners.', 5, 0),
(30, 30, 'People in the organization actively create beneficial alliances with partners.', 5, 0),
(31, 31, 'I''m clear on the business model of our organization.', 6, 0),
(32, 32, 'The future profitability of our organization is encouraging.', 6, 0),
(33, 33, 'I exercise fiscal responsibility.', 6, 0),
(34, 34, 'People know what is needed for the organization to be profitable.', 6, 0),
(35, 35, 'Employees feel positive about our organization’s profitability.', 6, 0),
(36, 36, 'My department operates within its budget.', 6, 0),
(37, 37, 'I know how to include others in my decision-making  processes.', 7, 0),
(38, 38, 'I''m committed to planning and other organizational processes at work.', 7, 0),
(39, 39, 'I initiate and engage in well constructed and finely executed processes.', 7, 0),
(40, 40, 'We know how to function as a team.', 7, 0),
(41, 41, 'People in the organization feel confident that our processes work.', 7, 0),
(42, 42, 'The necessary procedures are efficiently executed.', 7, 0),
(43, 43, 'I know how one goes about building a team that can implement the organization''s vision and governance model.', 8, 0),
(44, 44, 'I am excited about personal growth on the job.', 8, 0),
(45, 45, 'I''m equipped to come alongside my team members.', 8, 0),
(46, 46, 'People understand the value of learning from their mistakes.', 8, 0),
(47, 47, 'Employees feel affirmed on the job.', 8, 0),
(48, 48, 'Everyone helps each other.', 8, 0),
(49, 49, 'I understand the necessity of productive planning.', 9, 0),
(50, 50, 'The counsel of others who can sharpen my planning capacities is desirable.', 9, 0),
(51, 51, 'My skills as a proactive planner leave little room for improvement.', 9, 0),
(52, 52, 'The rationale behind the planning processes of my organization are really understood by everyone.', 9, 0),
(53, 53, 'Everyone feels included in the planning of the organization.', 9, 0),
(54, 54, 'People in the organization plan effectively.', 9, 0),
(55, 55, 'I know how to leverage to the maximum the place where my organization is situated.', 10, 0),
(56, 56, 'I am committed to understanding where I live.', 10, 0),
(57, 57, 'I have actively gotten to know the communities served by my organization.', 10, 0),
(58, 58, 'People understand the strategic location of our business.', 10, 0),
(59, 59, 'People are excited about opportunities afforded by the place they work.', 10, 0),
(60, 60, 'Our people are eager to serve our community.', 10, 0),
(61, 61, 'I understand the importance of creativity.', 11, 0),
(62, 62, 'I''m inspired by fresh insights.', 11, 0),
(63, 63, 'I am consistently creative in the different areas of my life.', 11, 0),
(64, 64, 'My organization understands the value of my creative abilities.', 11, 0),
(65, 65, 'People in my organization are encouraged by my fresh insights.', 11, 0),
(66, 66, 'I get opportunities to be innovative at work.', 11, 0),
(67, 67, 'I understand the value of friendships', 12, 0),
(68, 68, 'I am challenged and inspired by my friends.', 12, 0),
(69, 69, 'I take enough time to spend time with friends.', 12, 0),
(70, 70, 'Friendships and functions are equally valued in the organization.', 12, 0),
(71, 71, 'People feel eager to make friends with their colleagues.', 12, 0),
(72, 72, 'I have formed good friendships at work.', 12, 0),
(73, 73, 'The importance of empathetic listening cannot be overrated.', 13, 0),
(74, 74, 'I feel confident about myself and my abilities.', 13, 0),
(75, 75, 'I express a wide range of emotions constructively.', 13, 0),
(76, 76, 'We have a work culture of hearing one another.', 13, 0),
(77, 77, 'People feel validated in their emotions.', 13, 0),
(78, 78, 'Conflicts are well managed at work.', 13, 0),
(79, 79, 'I believe in the importance of having strong relationships with my family.', 14, 0),
(80, 80, 'I am encouraged and empowered by the members of my family.', 14, 0),
(81, 81, 'I enjoy spending time with my family and doing things with them.', 14, 0),
(82, 82, 'The company appreciates the impact of my work on my family.', 14, 0),
(83, 83, 'People don’t feel conflicted between work and family.', 14, 0),
(84, 84, 'The support of my family makes me more effective at work.', 14, 0),
(85, 85, 'I know what I believe.', 15, 0),
(86, 86, 'I am challenged to seek out deeper meaning in my life.', 15, 0),
(87, 87, 'I live out my faith in all the areas of my life.', 15, 0),
(88, 88, 'The meaning of faith is clear.', 15, 0),
(89, 89, 'My faith inspires my work.', 15, 0),
(90, 90, 'The company doesn’t put any obstacles in the way of my faith.', 15, 0),
(91, 91, 'Fun activities should be a routine part of life.', 16, 0),
(92, 92, 'Restoration comes through recreation.', 16, 0),
(93, 93, 'I have a lot of fun with the people I lead at work.', 16, 0),
(94, 94, 'My work understands the importance of fun.', 16, 0),
(95, 95, 'People feel refreshed by the fun they have at work.', 16, 0),
(96, 96, 'People get a lot of enjoyment out of work activities.', 16, 0),
(97, 97, 'Being healthy increases effectiveness at work.', 17, 0),
(98, 98, 'I desire to live a long, healthy life.', 17, 0),
(99, 99, 'Regular exercise and healthy living are integrated into my life.', 17, 0),
(100, 100, 'My work understands the relationship between health and productivity.', 17, 0),
(101, 101, 'People feel supported to maintain proper fitness.', 17, 0),
(102, 102, 'My work promotes healthy living practices.', 17, 0),
(103, 103, 'There needs to be a good connection between life purpose and spending.', 18, 0),
(104, 104, 'I am content with my financial situation.', 18, 0),
(105, 105, 'I manage my money constructively at home and at work.', 18, 0),
(106, 106, 'People are fairly compensated.', 18, 0),
(107, 107, 'People feel positive about how the company provides for them.', 18, 0),
(108, 108, 'People at work manage their finances well.', 18, 0),
(109, 109, 'My work is more than an occupation. It is a vocation to me.', 19, 0),
(110, 110, 'I am fulfilled in my work.', 19, 0),
(111, 111, 'I produce good quality work.', 19, 0),
(112, 112, 'People tend to see their work as a calling.', 19, 0),
(113, 113, 'People feel fulfilled at work.', 19, 0),
(114, 114, 'People produce good quality work.', 19, 0),
(115, 115, 'I am aware of my place in the broader context of society.', 20, 0),
(116, 116, 'I feel compassion for the people around me.', 20, 0),
(117, 117, 'I strategically invest myself in people who will multiply my life’s impact.', 20, 0),
(118, 118, 'The company understands its obligation to society.', 20, 0),
(119, 119, 'The people of the organization have compassion for others.', 20, 0),
(120, 120, 'My work creates opportunities for people to grow and develop.', 20, 0);
