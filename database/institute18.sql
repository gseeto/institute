...
ALTER TABLE lemon_assessment_french_questions ADD FOREIGN KEY lemon_type_id_idxfk (lemon_type_id) REFERENCES lemon_type (id);

ALTER TABLE lemon_assessment_french_questions ADD FOREIGN KEY id_idxfk (id) REFERENCES lemon_assessment_results (question_id);

ALTER TABLE lemon_assessment_questions ADD FOREIGN KEY lemon_type_id_idxfk_1 (lemon_type_id) REFERENCES lemon_type (id);
...
ALTER TABLE postventure_questions ADD FOREIGN KEY category_id_idxfk_4 (category_id) REFERENCES category_type (id);
...
ALTER TABLE seasonal_questions ADD FOREIGN KEY category_id_idxfk_5 (category_id) REFERENCES seasonal_category_type (id);
...
ALTER TABLE ten_f_questions ADD FOREIGN KEY category_id_idxfk_6 (category_id) REFERENCES f_category_type (id);
...
ALTER TABLE ten_p_questions ADD FOREIGN KEY category_id_idxfk_7 (category_id) REFERENCES category_type (id);
...
ALTER TABLE upward_questions ADD FOREIGN KEY category_id_idxfk_8 (category_id) REFERENCES upward_category_type (id);
...
ALTER TABLE business_checklist_results ADD FOREIGN KEY question_id_idxfk_10 (question_id) REFERENCES business_checklist_questions (id);
...
ALTER TABLE action_items ADD FOREIGN KEY category_id_idxfk_9 (category_id) REFERENCES category_type (id);
...
ALTER TABLE seasonal_assessment ADD FOREIGN KEY user_id_idxfk_10 (user_id) REFERENCES user (id);
...
ALTER TABLE time_assessment ADD FOREIGN KEY user_id_idxfk_13 (user_id) REFERENCES user (id);

ALTER TABLE time_assessment ADD FOREIGN KEY group_id_idxfk_8 (group_id) REFERENCES group_assessment_list (id);

ALTER TABLE businesschecklist_manager_assn ADD FOREIGN KEY user_id_idxfk_14 (user_id) REFERENCES user (id);
...
ALTER TABLE postventure_assessment ADD FOREIGN KEY resource_id_idxfk_11 (resource_id) REFERENCES resource (id);

ALTER TABLE postventure_assessment ADD FOREIGN KEY user_id_idxfk_15 (user_id) REFERENCES user (id);

ALTER TABLE postventure_assessment ADD FOREIGN KEY group_id_idxfk_9 (group_id) REFERENCES group_assessment_list (id);
