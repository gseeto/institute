<?php
	 ...
	 * listing a collection of ChecklistCategories objects.  It includes
	 ...
	 * 
	 */
	class ChecklistCategoriesDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ChecklistCategories datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ChecklistCategories object, or it can be any QQNode extending from QQN::ChecklistCategories().
		 * 
		 ...
		 * sorting using two fields from the ChecklistCategories object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ChecklistCategories
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ChecklistCategories::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from ChecklistCategories, given the clauses above
			$this->DataSource = ChecklistCategories::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ChecklistCategories-based QQNode.
		 * It will also verify that it is a proper ChecklistCategories-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'checklist_categories') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "checklist_categories".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ChecklistCategories()->Id;
				case 'Value': return QQN::ChecklistCategories()->Value;
				default: throw new QCallerException('Simple Property not found in ChecklistCategoriesDataGrid content: ' . $mixContent);
