<?php
	 ...
	 * listing a collection of BusinessChecklistResults objects.  It includes
	 ...
	 * 
	 */
	class BusinessChecklistResultsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this BusinessChecklistResults datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the BusinessChecklistResults object, or it can be any QQNode extending from QQN::BusinessChecklistResults().
		 * 
		 ...
		 * sorting using two fields from the BusinessChecklistResults object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from BusinessChecklistResults
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = BusinessChecklistResults::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from BusinessChecklistResults, given the clauses above
			$this->DataSource = BusinessChecklistResults::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a BusinessChecklistResults-based QQNode.
		 * It will also verify that it is a proper BusinessChecklistResults-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'business_checklist_results') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "business_checklist_results".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::BusinessChecklistResults()->Id;
				case 'QuestionId': return QQN::BusinessChecklistResults()->QuestionId;
				case 'Question': return QQN::BusinessChecklistResults()->Question;
				case 'ChecklistId': return QQN::BusinessChecklistResults()->ChecklistId;
				case 'Checklist': return QQN::BusinessChecklistResults()->Checklist;
				case 'Value': return QQN::BusinessChecklistResults()->Value;
				case 'UserId': return QQN::BusinessChecklistResults()->UserId;
				case 'User': return QQN::BusinessChecklistResults()->User;
				default: throw new QCallerException('Simple Property not found in BusinessChecklistResultsDataGrid content: ' . $mixContent);
