<?php
	 ...
	 * listing a collection of ConvergenceTime objects.  It includes
	 ...
	 * 
	 */
	class ConvergenceTimeDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ConvergenceTime datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ConvergenceTime object, or it can be any QQNode extending from QQN::ConvergenceTime().
		 * 
		 ...
		 * sorting using two fields from the ConvergenceTime object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ConvergenceTime
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ConvergenceTime::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from ConvergenceTime, given the clauses above
			$this->DataSource = ConvergenceTime::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ConvergenceTime-based QQNode.
		 * It will also verify that it is a proper ConvergenceTime-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'convergence_time') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "convergence_time".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ConvergenceTime()->Id;
				case 'UserId': return QQN::ConvergenceTime()->UserId;
				case 'User': return QQN::ConvergenceTime()->User;
				case 'Time': return QQN::ConvergenceTime()->Time;
				case 'Activity': return QQN::ConvergenceTime()->Activity;
				case 'Career': return QQN::ConvergenceTime()->Career;
				case 'Calling': return QQN::ConvergenceTime()->Calling;
				case 'Community': return QQN::ConvergenceTime()->Community;
				case 'Creativity': return QQN::ConvergenceTime()->Creativity;
				case 'Margin': return QQN::ConvergenceTime()->Margin;
				default: throw new QCallerException('Simple Property not found in ConvergenceTimeDataGrid content: ' . $mixContent);
