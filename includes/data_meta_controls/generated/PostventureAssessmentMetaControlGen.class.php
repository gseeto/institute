<?php
	 ...
	 * of the PostventureAssessment class.  This code-generated class
	 * contains all the basic elements to help a QPanel or QForm display an HTML form that can
	 * manipulate a single PostventureAssessment object.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QForm or QPanel which instantiates a PostventureAssessmentMetaControl
	 * class.
	 *
	 ...
	 * property-read PostventureAssessment $PostventureAssessment the actual PostventureAssessment data class being edited
	...
	class PostventureAssessmentMetaControlGen extends QBaseClass {
		// General Variables
		/**
		 * @var PostventureAssessment objPostventureAssessment
		 * @access protected
		 */
		...
		// Controls that allow the editing of PostventureAssessment's individual data fields
        /**
         * @var QLabel lblId;
         * @access protected
         */
		...
		// Controls that allow the viewing of PostventureAssessment's individual data fields
        /**
		 ...
		 * PostventureAssessmentMetaControl to edit a single PostventureAssessment object within the
		 * QPanel or QForm.
		 *
		 * This constructor takes in a single PostventureAssessment object, while any of the static
		 * create methods below can be used to construct based off of individual PK ID(s).
		 *
		 * @param mixed $objParentObject QForm or QPanel which will be using this PostventureAssessmentMetaControl
		 * @param PostventureAssessment $objPostventureAssessment new or existing PostventureAssessment object
		 */
		 public function __construct($objParentObject, PostventureAssessment $objPostventureAssessment) {
			// Setup Parent Object (e.g. QForm or QPanel which will be using this PostventureAssessmentMetaControl)
			$this->objParentObject = $objParentObject;

			// Setup linked PostventureAssessment object
			$this->objPostventureAssessment = $objPostventureAssessment;

			// Figure out if we're Editing or Creating New
			if ($this->objPostventureAssessment->__Restored) {
		 ...
		 * @param QMetaControlCreateType $intCreateType rules governing PostventureAssessment object creation - defaults to CreateOrEdit
 		 * @return PostventureAssessmentMetaControl
		 */
		public static function Create($objParentObject, $intId = null, $intCreateType = QMetaControlCreateType::CreateOrEdit) {
			// Attempt to Load from PK Arguments
			if (strlen($intId)) {
				$objPostventureAssessment = PostventureAssessment::Load($intId);

				// PostventureAssessment was found -- return it!
				if ($objPostventureAssessment)
					return new PostventureAssessmentMetaControl($objParentObject, $objPostventureAssessment);

				// If CreateOnRecordNotFound not specified, throw an exception
				else if ($intCreateType != QMetaControlCreateType::CreateOnRecordNotFound)
					throw new QCallerException('Could not find a PostventureAssessment object with PK arguments: ' . $intId);
			...
			return new PostventureAssessmentMetaControl($objParentObject, new PostventureAssessment());
		}
		...
		public static function CreateFromPathInfo($objParentObject, $intCreateType = QMetaControlCreateType::CreateOrEdit) {
			...
			return PostventureAssessmentMetaControl::Create($objParentObject, $intId, $intCreateType);
		}
		...
		public function lblId_Create($strControlId = null) {
			...
			if ($this->blnEditMode)
				$this->lblId->Text = $this->objPostventureAssessment->Id;
			else
				$this->lblId->Text = 'N/A';
			return $this->lblId;
		}
		...
		public function lstResourceStatus_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objResourceStatus = ResourceStatus::InstantiateCursor($objResourceStatusCursor)) {
				...
				if (($this->objPostventureAssessment->ResourceStatus) && ($this->objPostventureAssessment->ResourceStatus->Id == $objResourceStatus->Id))
		...
		public function lblResourceStatusId_Create($strControlId = null) {
			...
			$this->lblResourceStatusId->Text = ($this->objPostventureAssessment->ResourceStatus) ? $this->objPostventureAssessment->ResourceStatus->__toString() : null;
		...
		public function lstResource_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objResource = Resource::InstantiateCursor($objResourceCursor)) {
				...
				if (($this->objPostventureAssessment->Resource) && ($this->objPostventureAssessment->Resource->Id == $objResource->Id))
					$objListItem->Selected = true;
		...
		public function lblResourceId_Create($strControlId = null) {
			...
			$this->lblResourceId->Text = ($this->objPostventureAssessment->Resource) ? $this->objPostventureAssessment->Resource->__toString() : null;
		...
		public function lstUser_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objUser = User::InstantiateCursor($objUserCursor)) {
				...
				if (($this->objPostventureAssessment->User) && ($this->objPostventureAssessment->User->Id == $objUser->Id))
					$objListItem->Selected = true;
		...
		public function lblUserId_Create($strControlId = null) {
			...
			$this->lblUserId->Text = ($this->objPostventureAssessment->User) ? $this->objPostventureAssessment->User->__toString() : null;
		...
		public function lstGroup_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objGroup = GroupAssessmentList::InstantiateCursor($objGroupCursor)) {
				...
				if (($this->objPostventureAssessment->Group) && ($this->objPostventureAssessment->Group->Id == $objGroup->Id))
					$objListItem->Selected = true;
		...
		public function lblGroupId_Create($strControlId = null) {
			...
			$this->lblGroupId->Text = ($this->objPostventureAssessment->Group) ? $this->objPostventureAssessment->Group->__toString() : null;
		...
		/**
		 * Refresh this MetaControl with Data from the local PostventureAssessment object.
		 * @param boolean $blnReload reload PostventureAssessment from the database
		 * @return void
		 */
		public function Refresh($blnReload = false) {
			if ($blnReload)
				$this->objPostventureAssessment->Reload();

			if ($this->lblId) if ($this->blnEditMode) $this->lblId->Text = $this->objPostventureAssessment->Id;
			...
			if ($this->lblResourceStatusId) $this->lblResourceStatusId->Text = ($this->objPostventureAssessment->ResourceStatus) ? $this->objPostventureAssessment->ResourceStatus->__toString() : null;
			...
			if ($this->lblResourceId) $this->lblResourceId->Text = ($this->objPostventureAssessment->Resource) ? $this->objPostventureAssessment->Resource->__toString() : null;
			...
			if ($this->lblUserId) $this->lblUserId->Text = ($this->objPostventureAssessment->User) ? $this->objPostventureAssessment->User->__toString() : null;
			...
			if ($this->lblGroupId) $this->lblGroupId->Text = ($this->objPostventureAssessment->Group) ? $this->objPostventureAssessment->Group->__toString() : null;
		...
		///////////////////////////////////////////////
		// PUBLIC POSTVENTUREASSESSMENT OBJECT MANIPULATORS
		///////////////////////////////////////////////

		/**
		 * This will save this object's PostventureAssessment instance,
		 * updating only the fields which have had a control created for it.
		 */
		public function SavePostventureAssessment() {
			try {
				// Update any fields for controls that have been created
				if ($this->lstResourceStatus) $this->objPostventureAssessment->ResourceStatusId = $this->lstResourceStatus->SelectedValue;
				if ($this->lstResource) $this->objPostventureAssessment->ResourceId = $this->lstResource->SelectedValue;
				if ($this->lstUser) $this->objPostventureAssessment->UserId = $this->lstUser->SelectedValue;
				if ($this->lstGroup) $this->objPostventureAssessment->GroupId = $this->lstGroup->SelectedValue;

				// Update any UniqueReverseReferences (if any) for controls that have been created for it

				// Save the PostventureAssessment object
		...
		/**
		 * This will DELETE this object's PostventureAssessment instance from the database.
		 * It will also unassociate itself from any ManyToManyReferences.
		 */
		public function DeletePostventureAssessment() {
			$this->objPostventureAssessment->Delete();
		}		
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'PostventureAssessment': return $this->objPostventureAssessment;
				case 'TitleVerb': return $this->strTitleVerb;
				case 'EditMode': return $this->blnEditMode;

				// Controls that point to PostventureAssessment fields -- will be created dynamically if not yet created
				case 'IdControl':
		...
		public function __set($strName, $mixValue) {
			try {
				switch ($strName) {
					// Controls that point to PostventureAssessment fields
					case 'IdControl':
