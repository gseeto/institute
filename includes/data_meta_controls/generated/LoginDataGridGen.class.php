<?php
	 ...
	 * listing a collection of Login objects.  It includes
	 ...
	 * 
	 */
	class LoginDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Login datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Login object, or it can be any QQNode extending from QQN::Login().
		 * 
		 ...
		 * sorting using two fields from the Login object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Login
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Login::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Password': return QQN::Login()->Password;
				case 'Id': return QQN::Login()->Id;
				case 'RoleId': return QQN::Login()->RoleId;
				case 'Role': return QQN::Login()->Role;
