<?php
	 ...
	 * listing a collection of KingdomBusinessQuestions objects.  It includes
	 ...
	 * 
	 */
	class KingdomBusinessQuestionsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this KingdomBusinessQuestions datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the KingdomBusinessQuestions object, or it can be any QQNode extending from QQN::KingdomBusinessQuestions().
		 * 
		 ...
		 * sorting using two fields from the KingdomBusinessQuestions object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from KingdomBusinessQuestions
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = KingdomBusinessQuestions::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from KingdomBusinessQuestions, given the clauses above
			$this->DataSource = KingdomBusinessQuestions::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a KingdomBusinessQuestions-based QQNode.
		 * It will also verify that it is a proper KingdomBusinessQuestions-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'kingdom_business_questions') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "kingdom_business_questions".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::KingdomBusinessQuestions()->Id;
				case 'Count': return QQN::KingdomBusinessQuestions()->Count;
				case 'Text': return QQN::KingdomBusinessQuestions()->Text;
				case 'CategoryId': return QQN::KingdomBusinessQuestions()->CategoryId;
				default: throw new QCallerException('Simple Property not found in KingdomBusinessQuestionsDataGrid content: ' . $mixContent);
