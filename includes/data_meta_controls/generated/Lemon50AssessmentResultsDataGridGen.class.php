<?php
	 ...
	 * listing a collection of Lemon50AssessmentResults objects.  It includes
	 ...
	 * 
	 */
	class Lemon50AssessmentResultsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Lemon50AssessmentResults datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Lemon50AssessmentResults object, or it can be any QQNode extending from QQN::Lemon50AssessmentResults().
		 * 
		 ...
		 * sorting using two fields from the Lemon50AssessmentResults object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Lemon50AssessmentResults
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Lemon50AssessmentResults::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Lemon50AssessmentResults, given the clauses above
			$this->DataSource = Lemon50AssessmentResults::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Lemon50AssessmentResults-based QQNode.
		 * It will also verify that it is a proper Lemon50AssessmentResults-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'lemon50_assessment_results') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "lemon50_assessment_results".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Lemon50AssessmentResults()->Id;
				case 'QuestionId': return QQN::Lemon50AssessmentResults()->QuestionId;
				case 'Question': return QQN::Lemon50AssessmentResults()->Question;
				case 'AssessmentId': return QQN::Lemon50AssessmentResults()->AssessmentId;
				case 'Assessment': return QQN::Lemon50AssessmentResults()->Assessment;
				case 'Value': return QQN::Lemon50AssessmentResults()->Value;
				default: throw new QCallerException('Simple Property not found in Lemon50AssessmentResultsDataGrid content: ' . $mixContent);
