<?php
	 ...
	 * listing a collection of SeasonalQuestions objects.  It includes
	 ...
	 * 
	 */
	class SeasonalQuestionsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this SeasonalQuestions datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the SeasonalQuestions object, or it can be any QQNode extending from QQN::SeasonalQuestions().
		 * 
		 ...
		 * sorting using two fields from the SeasonalQuestions object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from SeasonalQuestions
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = SeasonalQuestions::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from SeasonalQuestions, given the clauses above
			$this->DataSource = SeasonalQuestions::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a SeasonalQuestions-based QQNode.
		 * It will also verify that it is a proper SeasonalQuestions-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'seasonal_questions') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "seasonal_questions".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::SeasonalQuestions()->Id;
				case 'Count': return QQN::SeasonalQuestions()->Count;
				case 'Text': return QQN::SeasonalQuestions()->Text;
				case 'CategoryId': return QQN::SeasonalQuestions()->CategoryId;
				case 'Invert': return QQN::SeasonalQuestions()->Invert;
				default: throw new QCallerException('Simple Property not found in SeasonalQuestionsDataGrid content: ' . $mixContent);
