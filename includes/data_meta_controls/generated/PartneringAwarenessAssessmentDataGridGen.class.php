<?php
	 ...
	 * listing a collection of PartneringAwarenessAssessment objects.  It includes
	 ...
	 * 
	 */
	class PartneringAwarenessAssessmentDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this PartneringAwarenessAssessment datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the PartneringAwarenessAssessment object, or it can be any QQNode extending from QQN::PartneringAwarenessAssessment().
		 * 
		 ...
		 * sorting using two fields from the PartneringAwarenessAssessment object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from PartneringAwarenessAssessment
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = PartneringAwarenessAssessment::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from PartneringAwarenessAssessment, given the clauses above
			$this->DataSource = PartneringAwarenessAssessment::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a PartneringAwarenessAssessment-based QQNode.
		 * It will also verify that it is a proper PartneringAwarenessAssessment-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'partnering_awareness_assessment') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "partnering_awareness_assessment".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::PartneringAwarenessAssessment()->Id;
				case 'ResourceStatusId': return QQN::PartneringAwarenessAssessment()->ResourceStatusId;
				case 'ResourceStatus': return QQN::PartneringAwarenessAssessment()->ResourceStatus;
				case 'CompanyId': return QQN::PartneringAwarenessAssessment()->CompanyId;
				case 'Company': return QQN::PartneringAwarenessAssessment()->Company;
				case 'ResourceId': return QQN::PartneringAwarenessAssessment()->ResourceId;
				case 'Resource': return QQN::PartneringAwarenessAssessment()->Resource;
				case 'UserId': return QQN::PartneringAwarenessAssessment()->UserId;
				case 'User': return QQN::PartneringAwarenessAssessment()->User;
				case 'GroupId': return QQN::PartneringAwarenessAssessment()->GroupId;
				case 'Group': return QQN::PartneringAwarenessAssessment()->Group;
				default: throw new QCallerException('Simple Property not found in PartneringAwarenessAssessmentDataGrid content: ' . $mixContent);
