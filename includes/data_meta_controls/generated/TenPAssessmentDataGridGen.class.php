<?php
	 ...
	 * listing a collection of TenPAssessment objects.  It includes
	 ...
	 * 
	 */
	class TenPAssessmentDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this TenPAssessment datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the TenPAssessment object, or it can be any QQNode extending from QQN::TenPAssessment().
		 * 
		 ...
		 * sorting using two fields from the TenPAssessment object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from TenPAssessment
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = TenPAssessment::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from TenPAssessment, given the clauses above
			$this->DataSource = TenPAssessment::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a TenPAssessment-based QQNode.
		 * It will also verify that it is a proper TenPAssessment-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'ten_p_assessment') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "ten_p_assessment".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::TenPAssessment()->Id;
				case 'ResourceStatusId': return QQN::TenPAssessment()->ResourceStatusId;
				case 'ResourceStatus': return QQN::TenPAssessment()->ResourceStatus;
				case 'CompanyId': return QQN::TenPAssessment()->CompanyId;
				case 'Company': return QQN::TenPAssessment()->Company;
				case 'ResourceId': return QQN::TenPAssessment()->ResourceId;
