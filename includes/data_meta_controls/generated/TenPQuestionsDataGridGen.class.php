<?php
	 ...
	 * listing a collection of TenPQuestions objects.  It includes
	 ...
	 * 
	 */
	class TenPQuestionsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this TenPQuestions datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the TenPQuestions object, or it can be any QQNode extending from QQN::TenPQuestions().
		 * 
		 ...
		 * sorting using two fields from the TenPQuestions object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from TenPQuestions
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = TenPQuestions::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from TenPQuestions, given the clauses above
			$this->DataSource = TenPQuestions::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a TenPQuestions-based QQNode.
		 * It will also verify that it is a proper TenPQuestions-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'ten_p_questions') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "ten_p_questions".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::TenPQuestions()->Id;
				case 'Count': return QQN::TenPQuestions()->Count;
				case 'Text': return QQN::TenPQuestions()->Text;
				case 'CategoryId': return QQN::TenPQuestions()->CategoryId;
				default: throw new QCallerException('Simple Property not found in TenPQuestionsDataGrid content: ' . $mixContent);
