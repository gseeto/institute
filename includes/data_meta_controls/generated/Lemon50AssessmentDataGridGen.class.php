<?php
	 ...
	 * listing a collection of Lemon50Assessment objects.  It includes
	 ...
	 * 
	 */
	class Lemon50AssessmentDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Lemon50Assessment datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Lemon50Assessment object, or it can be any QQNode extending from QQN::Lemon50Assessment().
		 * 
		 ...
		 * sorting using two fields from the Lemon50Assessment object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Lemon50Assessment
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Lemon50Assessment::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Lemon50Assessment, given the clauses above
			$this->DataSource = Lemon50Assessment::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Lemon50Assessment-based QQNode.
		 * It will also verify that it is a proper Lemon50Assessment-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'lemon50_assessment') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "lemon50_assessment".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Lemon50Assessment()->Id;
				case 'UserId': return QQN::Lemon50Assessment()->UserId;
				case 'User': return QQN::Lemon50Assessment()->User;
				case 'ResourceId': return QQN::Lemon50Assessment()->ResourceId;
				case 'Resource': return QQN::Lemon50Assessment()->Resource;
				case 'GroupId': return QQN::Lemon50Assessment()->GroupId;
				case 'Group': return QQN::Lemon50Assessment()->Group;
				case 'L': return QQN::Lemon50Assessment()->L;
				case 'E': return QQN::Lemon50Assessment()->E;
				case 'M': return QQN::Lemon50Assessment()->M;
				case 'O': return QQN::Lemon50Assessment()->O;
				case 'N': return QQN::Lemon50Assessment()->N;
				case 'DateModified': return QQN::Lemon50Assessment()->DateModified;
				case 'ResourceStatusId': return QQN::Lemon50Assessment()->ResourceStatusId;
				default: throw new QCallerException('Simple Property not found in Lemon50AssessmentDataGrid content: ' . $mixContent);
