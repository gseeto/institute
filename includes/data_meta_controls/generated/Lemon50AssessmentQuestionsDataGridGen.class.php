<?php
	 ...
	 * listing a collection of Lemon50AssessmentQuestions objects.  It includes
	 ...
	 * 
	 */
	class Lemon50AssessmentQuestionsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Lemon50AssessmentQuestions datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Lemon50AssessmentQuestions object, or it can be any QQNode extending from QQN::Lemon50AssessmentQuestions().
		 * 
		 ...
		 * sorting using two fields from the Lemon50AssessmentQuestions object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Lemon50AssessmentQuestions
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Lemon50AssessmentQuestions::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Lemon50AssessmentQuestions, given the clauses above
			$this->DataSource = Lemon50AssessmentQuestions::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Lemon50AssessmentQuestions-based QQNode.
		 * It will also verify that it is a proper Lemon50AssessmentQuestions-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'lemon50_assessment_questions') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "lemon50_assessment_questions".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Lemon50AssessmentQuestions()->Id;
				case 'Count': return QQN::Lemon50AssessmentQuestions()->Count;
				case 'Text': return QQN::Lemon50AssessmentQuestions()->Text;
				case 'LemonTypeId': return QQN::Lemon50AssessmentQuestions()->LemonTypeId;
				case 'Inverse': return QQN::Lemon50AssessmentQuestions()->Inverse;
				default: throw new QCallerException('Simple Property not found in Lemon50AssessmentQuestionsDataGrid content: ' . $mixContent);
