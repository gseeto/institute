<?php
	 ...
	 * listing a collection of BusinessChecklistQuestions objects.  It includes
	 ...
	 * 
	 */
	class BusinessChecklistQuestionsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this BusinessChecklistQuestions datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the BusinessChecklistQuestions object, or it can be any QQNode extending from QQN::BusinessChecklistQuestions().
		 * 
		 ...
		 * sorting using two fields from the BusinessChecklistQuestions object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from BusinessChecklistQuestions
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = BusinessChecklistQuestions::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from BusinessChecklistQuestions, given the clauses above
			$this->DataSource = BusinessChecklistQuestions::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a BusinessChecklistQuestions-based QQNode.
		 * It will also verify that it is a proper BusinessChecklistQuestions-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'business_checklist_questions') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "business_checklist_questions".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::BusinessChecklistQuestions()->Id;
				case 'Count': return QQN::BusinessChecklistQuestions()->Count;
				case 'Text': return QQN::BusinessChecklistQuestions()->Text;
				case 'CategoryId': return QQN::BusinessChecklistQuestions()->CategoryId;
				case 'Category': return QQN::BusinessChecklistQuestions()->Category;
				default: throw new QCallerException('Simple Property not found in BusinessChecklistQuestionsDataGrid content: ' . $mixContent);
