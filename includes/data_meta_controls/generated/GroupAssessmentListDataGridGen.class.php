<?php
	 ...
	 * listing a collection of GroupAssessmentList objects.  It includes
	 ...
	 * 
	 */
	class GroupAssessmentListDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this GroupAssessmentList datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the GroupAssessmentList object, or it can be any QQNode extending from QQN::GroupAssessmentList().
		 * 
		 ...
		 * sorting using two fields from the GroupAssessmentList object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from GroupAssessmentList
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = GroupAssessmentList::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from GroupAssessmentList, given the clauses above
			$this->DataSource = GroupAssessmentList::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a GroupAssessmentList-based QQNode.
		 * It will also verify that it is a proper GroupAssessmentList-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'group_assessment_list') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "group_assessment_list".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::GroupAssessmentList()->Id;
				case 'TotalKeys': return QQN::GroupAssessmentList()->TotalKeys;
				case 'KeysLeft': return QQN::GroupAssessmentList()->KeysLeft;
				case 'ResourceId': return QQN::GroupAssessmentList()->ResourceId;
