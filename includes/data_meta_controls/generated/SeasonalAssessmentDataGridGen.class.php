<?php
	 ...
	 * listing a collection of SeasonalAssessment objects.  It includes
	 ...
	 * 
	 */
	class SeasonalAssessmentDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this SeasonalAssessment datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the SeasonalAssessment object, or it can be any QQNode extending from QQN::SeasonalAssessment().
		 * 
		 ...
		 * sorting using two fields from the SeasonalAssessment object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from SeasonalAssessment
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = SeasonalAssessment::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from SeasonalAssessment, given the clauses above
			$this->DataSource = SeasonalAssessment::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a SeasonalAssessment-based QQNode.
		 * It will also verify that it is a proper SeasonalAssessment-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'seasonal_assessment') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "seasonal_assessment".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::SeasonalAssessment()->Id;
				case 'ResourceStatusId': return QQN::SeasonalAssessment()->ResourceStatusId;
				case 'ResourceStatus': return QQN::SeasonalAssessment()->ResourceStatus;
				case 'ResourceId': return QQN::SeasonalAssessment()->ResourceId;
				case 'Resource': return QQN::SeasonalAssessment()->Resource;
				case 'UserId': return QQN::SeasonalAssessment()->UserId;
				case 'User': return QQN::SeasonalAssessment()->User;
				case 'GroupId': return QQN::SeasonalAssessment()->GroupId;
				case 'Group': return QQN::SeasonalAssessment()->Group;
				default: throw new QCallerException('Simple Property not found in SeasonalAssessmentDataGrid content: ' . $mixContent);
