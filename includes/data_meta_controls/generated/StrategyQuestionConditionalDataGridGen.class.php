<?php
	 ...
	 * listing a collection of StrategyQuestionConditional objects.  It includes
	 ...
	 * 
	 */
	class StrategyQuestionConditionalDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this StrategyQuestionConditional datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the StrategyQuestionConditional object, or it can be any QQNode extending from QQN::StrategyQuestionConditional().
		 * 
		 ...
		 * sorting using two fields from the StrategyQuestionConditional object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from StrategyQuestionConditional
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = StrategyQuestionConditional::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from StrategyQuestionConditional, given the clauses above
			$this->DataSource = StrategyQuestionConditional::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a StrategyQuestionConditional-based QQNode.
		 * It will also verify that it is a proper StrategyQuestionConditional-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'strategy_question_conditional') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "strategy_question_conditional".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::StrategyQuestionConditional()->Id;
				case 'QuestionId': return QQN::StrategyQuestionConditional()->QuestionId;
				case 'Question': return QQN::StrategyQuestionConditional()->Question;
				case 'StrategyId': return QQN::StrategyQuestionConditional()->StrategyId;
				case 'Strategy': return QQN::StrategyQuestionConditional()->Strategy;
				case 'ConditionalType': return QQN::StrategyQuestionConditional()->ConditionalType;
				default: throw new QCallerException('Simple Property not found in StrategyQuestionConditionalDataGrid content: ' . $mixContent);
