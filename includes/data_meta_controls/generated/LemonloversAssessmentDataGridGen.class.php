<?php
	 ...
	 * listing a collection of LemonloversAssessment objects.  It includes
	 ...
	 * 
	 */
	class LemonloversAssessmentDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this LemonloversAssessment datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the LemonloversAssessment object, or it can be any QQNode extending from QQN::LemonloversAssessment().
		 * 
		 ...
		 * sorting using two fields from the LemonloversAssessment object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from LemonloversAssessment
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = LemonloversAssessment::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from LemonloversAssessment, given the clauses above
			$this->DataSource = LemonloversAssessment::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a LemonloversAssessment-based QQNode.
		 * It will also verify that it is a proper LemonloversAssessment-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'lemonlovers_assessment') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "lemonlovers_assessment".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::LemonloversAssessment()->Id;
				case 'UserId': return QQN::LemonloversAssessment()->UserId;
				case 'User': return QQN::LemonloversAssessment()->User;
				case 'CompanyId': return QQN::LemonloversAssessment()->CompanyId;
				case 'Company': return QQN::LemonloversAssessment()->Company;
				case 'ResourceId': return QQN::LemonloversAssessment()->ResourceId;
				case 'Resource': return QQN::LemonloversAssessment()->Resource;
				case 'ResourceStatusId': return QQN::LemonloversAssessment()->ResourceStatusId;
				case 'GroupId': return QQN::LemonloversAssessment()->GroupId;
				case 'Group': return QQN::LemonloversAssessment()->Group;
				case 'L': return QQN::LemonloversAssessment()->L;
				case 'E': return QQN::LemonloversAssessment()->E;
				case 'M': return QQN::LemonloversAssessment()->M;
				case 'O': return QQN::LemonloversAssessment()->O;
				case 'N': return QQN::LemonloversAssessment()->N;
				case 'DateModified': return QQN::LemonloversAssessment()->DateModified;
				default: throw new QCallerException('Simple Property not found in LemonloversAssessmentDataGrid content: ' . $mixContent);
