<?php
	...
	class RoleMetaControlGen extends QBaseClass {
		...
		public static function Create($objParentObject, $intId = null, $intCreateType = QMetaControlCreateType::CreateOrEdit) {
			...
			if (strlen($intId)) {
				...
				// If CreateOnRecordNotFound not specified, throw an exception
					...
					throw new QCallerException('Could not find a Role object with PK arguments: ' . $intId);
		...
		public static function CreateFromPathInfo($objParentObject, $intCreateType = QMetaControlCreateType::CreateOrEdit) {
			...
			return RoleMetaControl::Create($objParentObject, $intId, $intCreateType);
		}
		...
		public function lblId_Create($strControlId = null) {
			...
			if ($this->blnEditMode)
				$this->lblId->Text = $this->objRole->Id;
			else
				$this->lblId->Text = 'N/A';
			return $this->lblId;
		}
		...
		public function txtName_Create($strControlId = null) {
			...
			$this->txtName->MaxLength = Role::NameMaxLength;
			return $this->txtName;
		}
		...
		public function lblName_Create($strControlId = null) {
			...
			$this->lblName->Text = $this->objRole->Name;
			return $this->lblName;
		}
		...
		public function Refresh($blnReload = false) {
			...
			if ($this->lblId) if ($this->blnEditMode) $this->lblId->Text = $this->objRole->Id;

			if ($this->txtName) $this->txtName->Text = $this->objRole->Name;
			if ($this->lblName) $this->lblName->Text = $this->objRole->Name;
		...
		public function SaveRole() {
			try {
				...
				if ($this->txtName) $this->objRole->Name = $this->txtName->Text;
