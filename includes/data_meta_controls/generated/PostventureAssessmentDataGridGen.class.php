<?php
	 ...
	 * listing a collection of PostventureAssessment objects.  It includes
	 ...
	 * 
	 */
	class PostventureAssessmentDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this PostventureAssessment datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the PostventureAssessment object, or it can be any QQNode extending from QQN::PostventureAssessment().
		 * 
		 ...
		 * sorting using two fields from the PostventureAssessment object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from PostventureAssessment
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = PostventureAssessment::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from PostventureAssessment, given the clauses above
			$this->DataSource = PostventureAssessment::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a PostventureAssessment-based QQNode.
		 * It will also verify that it is a proper PostventureAssessment-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'postventure_assessment') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "postventure_assessment".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::PostventureAssessment()->Id;
				case 'ResourceStatusId': return QQN::PostventureAssessment()->ResourceStatusId;
				case 'ResourceStatus': return QQN::PostventureAssessment()->ResourceStatus;
				case 'ResourceId': return QQN::PostventureAssessment()->ResourceId;
				case 'Resource': return QQN::PostventureAssessment()->Resource;
				case 'UserId': return QQN::PostventureAssessment()->UserId;
				case 'User': return QQN::PostventureAssessment()->User;
				case 'GroupId': return QQN::PostventureAssessment()->GroupId;
				case 'Group': return QQN::PostventureAssessment()->Group;
				default: throw new QCallerException('Simple Property not found in PostventureAssessmentDataGrid content: ' . $mixContent);
