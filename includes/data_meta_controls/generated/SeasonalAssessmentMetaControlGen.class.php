<?php
	 ...
	 * manipulate a single SeasonalAssessment object.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QForm or QPanel which instantiates a SeasonalAssessmentMetaControl
	 * class.
	 *
	 ...
	 * property-read SeasonalAssessment $SeasonalAssessment the actual SeasonalAssessment data class being edited
	...
	class SeasonalAssessmentMetaControlGen extends QBaseClass {
		// General Variables
		/**
		 * @var SeasonalAssessment objSeasonalAssessment
		 * @access protected
		 */
		...
		// Controls that allow the editing of SeasonalAssessment's individual data fields
        /**
         * @var QLabel lblId;
         * @access protected
         */
		...
		// Controls that allow the viewing of SeasonalAssessment's individual data fields
        /**
		 ...
		 * SeasonalAssessmentMetaControl to edit a single SeasonalAssessment object within the
		 * QPanel or QForm.
		 *
		 * This constructor takes in a single SeasonalAssessment object, while any of the static
		 * create methods below can be used to construct based off of individual PK ID(s).
		 *
		 * @param mixed $objParentObject QForm or QPanel which will be using this SeasonalAssessmentMetaControl
		 * @param SeasonalAssessment $objSeasonalAssessment new or existing SeasonalAssessment object
		 */
		 public function __construct($objParentObject, SeasonalAssessment $objSeasonalAssessment) {
			// Setup Parent Object (e.g. QForm or QPanel which will be using this SeasonalAssessmentMetaControl)
			$this->objParentObject = $objParentObject;

			// Setup linked SeasonalAssessment object
			$this->objSeasonalAssessment = $objSeasonalAssessment;

			// Figure out if we're Editing or Creating New
			if ($this->objSeasonalAssessment->__Restored) {
		 ...
		 * @param QMetaControlCreateType $intCreateType rules governing SeasonalAssessment object creation - defaults to CreateOrEdit
 		 * @return SeasonalAssessmentMetaControl
		 */
		public static function Create($objParentObject, $intId = null, $intCreateType = QMetaControlCreateType::CreateOrEdit) {
			// Attempt to Load from PK Arguments
			if (strlen($intId)) {
				$objSeasonalAssessment = SeasonalAssessment::Load($intId);

				// SeasonalAssessment was found -- return it!
				if ($objSeasonalAssessment)
					return new SeasonalAssessmentMetaControl($objParentObject, $objSeasonalAssessment);

				// If CreateOnRecordNotFound not specified, throw an exception
				else if ($intCreateType != QMetaControlCreateType::CreateOnRecordNotFound)
					throw new QCallerException('Could not find a SeasonalAssessment object with PK arguments: ' . $intId);
			...
			return new SeasonalAssessmentMetaControl($objParentObject, new SeasonalAssessment());
		}
		...
		public static function CreateFromPathInfo($objParentObject, $intCreateType = QMetaControlCreateType::CreateOrEdit) {
			...
			return SeasonalAssessmentMetaControl::Create($objParentObject, $intId, $intCreateType);
		}
		...
		public function lblId_Create($strControlId = null) {
			...
			if ($this->blnEditMode)
				$this->lblId->Text = $this->objSeasonalAssessment->Id;
			else
				$this->lblId->Text = 'N/A';
			return $this->lblId;
		}
		...
		public function lstResourceStatus_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objResourceStatus = ResourceStatus::InstantiateCursor($objResourceStatusCursor)) {
				...
				if (($this->objSeasonalAssessment->ResourceStatus) && ($this->objSeasonalAssessment->ResourceStatus->Id == $objResourceStatus->Id))
		...
		public function lblResourceStatusId_Create($strControlId = null) {
			...
			$this->lblResourceStatusId->Text = ($this->objSeasonalAssessment->ResourceStatus) ? $this->objSeasonalAssessment->ResourceStatus->__toString() : null;
		...
		public function lstResource_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objResource = Resource::InstantiateCursor($objResourceCursor)) {
				...
				if (($this->objSeasonalAssessment->Resource) && ($this->objSeasonalAssessment->Resource->Id == $objResource->Id))
					$objListItem->Selected = true;
		...
		public function lblResourceId_Create($strControlId = null) {
			...
			$this->lblResourceId->Text = ($this->objSeasonalAssessment->Resource) ? $this->objSeasonalAssessment->Resource->__toString() : null;
		...
		public function lstUser_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objUser = User::InstantiateCursor($objUserCursor)) {
				...
				if (($this->objSeasonalAssessment->User) && ($this->objSeasonalAssessment->User->Id == $objUser->Id))
					$objListItem->Selected = true;
		...
		public function lblUserId_Create($strControlId = null) {
			...
			$this->lblUserId->Text = ($this->objSeasonalAssessment->User) ? $this->objSeasonalAssessment->User->__toString() : null;
		...
		public function lstGroup_Create($strControlId = null, QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			while ($objGroup = GroupAssessmentList::InstantiateCursor($objGroupCursor)) {
				...
				if (($this->objSeasonalAssessment->Group) && ($this->objSeasonalAssessment->Group->Id == $objGroup->Id))
					$objListItem->Selected = true;
		...
		public function lblGroupId_Create($strControlId = null) {
			...
			$this->lblGroupId->Text = ($this->objSeasonalAssessment->Group) ? $this->objSeasonalAssessment->Group->__toString() : null;
		...
		/**
		 * Refresh this MetaControl with Data from the local SeasonalAssessment object.
		 * @param boolean $blnReload reload SeasonalAssessment from the database
		 * @return void
		 */
		public function Refresh($blnReload = false) {
			if ($blnReload)
				$this->objSeasonalAssessment->Reload();

			if ($this->lblId) if ($this->blnEditMode) $this->lblId->Text = $this->objSeasonalAssessment->Id;
			...
			if ($this->lblResourceStatusId) $this->lblResourceStatusId->Text = ($this->objSeasonalAssessment->ResourceStatus) ? $this->objSeasonalAssessment->ResourceStatus->__toString() : null;
			...
			if ($this->lblResourceId) $this->lblResourceId->Text = ($this->objSeasonalAssessment->Resource) ? $this->objSeasonalAssessment->Resource->__toString() : null;
			...
			if ($this->lblUserId) $this->lblUserId->Text = ($this->objSeasonalAssessment->User) ? $this->objSeasonalAssessment->User->__toString() : null;
			...
			if ($this->lblGroupId) $this->lblGroupId->Text = ($this->objSeasonalAssessment->Group) ? $this->objSeasonalAssessment->Group->__toString() : null;
		...
		///////////////////////////////////////////////
		// PUBLIC SEASONALASSESSMENT OBJECT MANIPULATORS
		///////////////////////////////////////////////

		/**
		 * This will save this object's SeasonalAssessment instance,
		 * updating only the fields which have had a control created for it.
		 */
		public function SaveSeasonalAssessment() {
			try {
				// Update any fields for controls that have been created
				if ($this->lstResourceStatus) $this->objSeasonalAssessment->ResourceStatusId = $this->lstResourceStatus->SelectedValue;
				if ($this->lstResource) $this->objSeasonalAssessment->ResourceId = $this->lstResource->SelectedValue;
				if ($this->lstUser) $this->objSeasonalAssessment->UserId = $this->lstUser->SelectedValue;
				if ($this->lstGroup) $this->objSeasonalAssessment->GroupId = $this->lstGroup->SelectedValue;

				// Update any UniqueReverseReferences (if any) for controls that have been created for it

				// Save the SeasonalAssessment object
		...
		/**
		 * This will DELETE this object's SeasonalAssessment instance from the database.
		 * It will also unassociate itself from any ManyToManyReferences.
		 */
		public function DeleteSeasonalAssessment() {
			$this->objSeasonalAssessment->Delete();
		}		
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'SeasonalAssessment': return $this->objSeasonalAssessment;
				case 'TitleVerb': return $this->strTitleVerb;
				case 'EditMode': return $this->blnEditMode;

				// Controls that point to SeasonalAssessment fields -- will be created dynamically if not yet created
				case 'IdControl':
		...
		public function __set($strName, $mixValue) {
			try {
				switch ($strName) {
					// Controls that point to SeasonalAssessment fields
					case 'IdControl':
