<?php
	require(__DATAGEN_META_CONTROLS__ . '/KpisDataGridGen.class.php');

	/**
	 * This is the "Meta" DataGrid customizable subclass for the List functionality
	 * of the Kpis class.  This code-generated class extends
	 * from the generated Meta DataGrid class which contains a QDataGrid class which
	 * can be used by any QForm or QPanel, listing a collection of Kpis
	 ...
	 * 
	 */
	class KpisDataGrid extends KpisDataGridGen {
	}
?>