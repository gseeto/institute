<?php
	/**
	 * The abstract LemonAssessmentGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the LemonAssessment subclass which
	 * extends this LemonAssessmentGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the LemonAssessment class.
	 * 
	 ...
	 * @property LemonAssessmentResults $_LemonAssessmentResultsAsAssessment the value for the private _objLemonAssessmentResultsAsAssessment (Read-Only) if set due to an expansion on the lemon_assessment_results.assessment_id reverse relationship
	 * @property LemonAssessmentResults[] $_LemonAssessmentResultsAsAssessmentArray the value for the private _objLemonAssessmentResultsAsAssessmentArray (Read-Only) if set due to an ExpandAsArray on the lemon_assessment_results.assessment_id reverse relationship
	 * @property boolean $__Restored whether or not this object was restored from the database (as opposed to created new)
	 */
	class LemonAssessmentGen extends QBaseClass {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column lemon_assessment.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column lemon_assessment.user_id
		...
		/**
		 * Protected member variable that maps to the database column lemon_assessment.company_id
		...
		/**
		 * Protected member variable that maps to the database column lemon_assessment.resource_id
		...
		/**
		 * Protected member variable that maps to the database column lemon_assessment.resource_status_id
		...
		/**
		 * Protected member variable that maps to the database column lemon_assessment.group_id
		...
		/**
		 * Private member variable that stores a reference to a single LemonAssessmentResultsAsAssessment object
		 * (of type LemonAssessmentResults), if this LemonAssessment object was restored with
		 * an expansion on the lemon_assessment_results association table.
		 * @var LemonAssessmentResults _objLemonAssessmentResultsAsAssessment;
		 */
		private $_objLemonAssessmentResultsAsAssessment;

		/**
		 * Private member variable that stores a reference to an array of LemonAssessmentResultsAsAssessment objects
		 * (of type LemonAssessmentResults[]), if this LemonAssessment object was restored with
		 * an ExpandAsArray on the lemon_assessment_results association table.
		 * @var LemonAssessmentResults[] _objLemonAssessmentResultsAsAssessmentArray;
		 */
		private $_objLemonAssessmentResultsAsAssessmentArray = array();
		 ...
		 * in the database column lemon_assessment.user_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column lemon_assessment.company_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column lemon_assessment.resource_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column lemon_assessment.group_id.
		 *
		...
		/**
		 * Load a LemonAssessment from PK Info
		 * @param integer $intId
		 * @return LemonAssessment
		 */
		public static function Load($intId) {
			// Use QuerySingle to Perform the Query
			return LemonAssessment::QuerySingle(
				QQ::Equal(QQN::LemonAssessment()->Id, $intId)
			);
		}

		/**
		 * Load all LemonAssessments
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return LemonAssessment[]
		 */
		public static function LoadAll($objOptionalClauses = null) {
			// Call LemonAssessment::QueryArray to perform the LoadAll query
			try {
				return LemonAssessment::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all LemonAssessments
		 * @return int
		 */
		public static function CountAll() {
			// Call LemonAssessment::QueryCount to perform the CountAll query
			return LemonAssessment::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = LemonAssessment::GetDatabase();

			// Create/Build out the QueryBuilder object with LemonAssessment-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'lemon_assessment');
			LemonAssessment::GetSelectFields($objQueryBuilder);
			$objQueryBuilder->AddFromItem('lemon_assessment');
		...
		/**
		 * Static Qcodo Query method to query for a single LemonAssessment object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return LemonAssessment the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = LemonAssessment::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
			...
			// Instantiate a new LemonAssessment object and return it

			// Do we have to expand anything?
			if ($objQueryBuilder->ExpandAsArrayNodes) {
				$objToReturn = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = LemonAssessment::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNodes, $objToReturn, $objQueryBuilder->ColumnAliasArray);
				...
				return LemonAssessment::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcodo Query method to query for an array of LemonAssessment objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return LemonAssessment[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return LemonAssessment::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcodo Query method to query for a count of LemonAssessment objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = LemonAssessment::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
			...
			$objCache = new QCache('query', 'lemon_assessment_' . serialize($strConditions));
			if (!($strQuery = $objCache->GetData())) {
				// Not Found -- Go ahead and Create/Build out a new QueryBuilder object with LemonAssessment-specific fields
				$objQueryBuilder = new QQueryBuilder($objDatabase);
				LemonAssessment::GetSelectFields($objQueryBuilder);
				LemonAssessment::GetFromFields($objQueryBuilder);
			...
			return LemonAssessment::InstantiateDbResult($objDbResult);
		}*/

		/**
		 * Updates a QQueryBuilder with the SELECT fields for this LemonAssessment
		...
		/**
		 * Instantiate a LemonAssessment from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this LemonAssessment::InstantiateDbRow in order to perform
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null, $strColumnAliasArray = array()) {
			...
			if (($strExpandAsArrayNodes) && ($objPreviousItem) &&
				...
				if (!$strAliasPrefix)
					$strAliasPrefix = 'lemon_assessment__';


				$strAlias = $strAliasPrefix . 'lemonassessmentresultsasassessment__id';
				$strAliasName = array_key_exists($strAlias, $strColumnAliasArray) ? $strColumnAliasArray[$strAlias] : $strAlias;
				if ((array_key_exists($strAlias, $strExpandAsArrayNodes)) &&
					(!is_null($objDbRow->GetColumn($strAliasName)))) {
					if ($intPreviousChildItemCount = count($objPreviousItem->_objLemonAssessmentResultsAsAssessmentArray)) {
						$objPreviousChildItem = $objPreviousItem->_objLemonAssessmentResultsAsAssessmentArray[$intPreviousChildItemCount - 1];
						$objChildItem = LemonAssessmentResults::InstantiateDbRow($objDbRow, $strAliasPrefix . 'lemonassessmentresultsasassessment__', $strExpandAsArrayNodes, $objPreviousChildItem, $strColumnAliasArray);
						if ($objChildItem)
							$objPreviousItem->_objLemonAssessmentResultsAsAssessmentArray[] = $objChildItem;
					} else
						$objPreviousItem->_objLemonAssessmentResultsAsAssessmentArray[] = LemonAssessmentResults::InstantiateDbRow($objDbRow, $strAliasPrefix . 'lemonassessmentresultsasassessment__', $strExpandAsArrayNodes, null, $strColumnAliasArray);
				...
				if ($blnExpandedViaArray)
					return false;
				else if ($strAliasPrefix == 'lemon_assessment__')
					$strAliasPrefix = null;
			}

			// Create a new instance of the LemonAssessment object
			$objToReturn = new LemonAssessment();
			...
			// Check for LemonAssessmentResultsAsAssessment Virtual Binding
			$strAlias = $strAliasPrefix . 'lemonassessmentresultsasassessment__id';
			$strAliasName = array_key_exists($strAlias, $strColumnAliasArray) ? $strColumnAliasArray[$strAlias] : $strAlias;
			if (!is_null($objDbRow->GetColumn($strAliasName))) {
				if (($strExpandAsArrayNodes) && (array_key_exists($strAlias, $strExpandAsArrayNodes)))
					$objToReturn->_objLemonAssessmentResultsAsAssessmentArray[] = LemonAssessmentResults::InstantiateDbRow($objDbRow, $strAliasPrefix . 'lemonassessmentresultsasassessment__', $strExpandAsArrayNodes, null, $strColumnAliasArray);
				else
					$objToReturn->_objLemonAssessmentResultsAsAssessment = LemonAssessmentResults::InstantiateDbRow($objDbRow, $strAliasPrefix . 'lemonassessmentresultsasassessment__', $strExpandAsArrayNodes, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate an array of LemonAssessments from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null, $strColumnAliasArray = null) {
			...
			if ($strExpandAsArrayNodes) {
				$objLastRowItem = null;
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = LemonAssessment::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = LemonAssessment::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single LemonAssessment object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return LemonAssessment next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return LemonAssessment::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single LemonAssessment object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @return LemonAssessment
		*/
		...
		/**
		 * Load an array of LemonAssessment objects,
		 * by UserId Index(es)
		...
		*/
		public static function LoadArrayByUserId($intUserId, $objOptionalClauses = null) {
			// Call LemonAssessment::QueryArray to perform the LoadArrayByUserId query
			try {
				return LemonAssessment::QueryArray(
					QQ::Equal(QQN::LemonAssessment()->UserId, $intUserId),
					$objOptionalClauses
					);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
		...
		/**
		 * Count LemonAssessments
		 * by UserId Index(es)
		 * @param integer $intUserId
		 * @return int
		*/
		public static function CountByUserId($intUserId, $objOptionalClauses = null) {
			// Call LemonAssessment::QueryCount to perform the CountByUserId query
			return LemonAssessment::QueryCount(
				QQ::Equal(QQN::LemonAssessment()->UserId, $intUserId)
			, $objOptionalClauses
			);
		}
		...
		*/
		public static function LoadArrayByCompanyId($intCompanyId, $objOptionalClauses = null) {
			// Call LemonAssessment::QueryArray to perform the LoadArrayByCompanyId query
			try {
				return LemonAssessment::QueryArray(
					QQ::Equal(QQN::LemonAssessment()->CompanyId, $intCompanyId),
					$objOptionalClauses
					);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
		...
		*/
		public static function CountByCompanyId($intCompanyId, $objOptionalClauses = null) {
			// Call LemonAssessment::QueryCount to perform the CountByCompanyId query
			return LemonAssessment::QueryCount(
				QQ::Equal(QQN::LemonAssessment()->CompanyId, $intCompanyId)
			, $objOptionalClauses
			);
		...
		*/
		public static function LoadArrayByResourceId($intResourceId, $objOptionalClauses = null) {
			// Call LemonAssessment::QueryArray to perform the LoadArrayByResourceId query
			try {
				return LemonAssessment::QueryArray(
					QQ::Equal(QQN::LemonAssessment()->ResourceId, $intResourceId),
					$objOptionalClauses
					);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
		...
		*/
		public static function CountByResourceId($intResourceId, $objOptionalClauses = null) {
			// Call LemonAssessment::QueryCount to perform the CountByResourceId query
			return LemonAssessment::QueryCount(
				QQ::Equal(QQN::LemonAssessment()->ResourceId, $intResourceId)
			, $objOptionalClauses
			);
		...
		*/
		public static function LoadArrayByGroupId($intGroupId, $objOptionalClauses = null) {
			// Call LemonAssessment::QueryArray to perform the LoadArrayByGroupId query
			try {
				return LemonAssessment::QueryArray(
					QQ::Equal(QQN::LemonAssessment()->GroupId, $intGroupId),
					$objOptionalClauses
					);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
		...
		*/
		public static function CountByGroupId($intGroupId, $objOptionalClauses = null) {
			// Call LemonAssessment::QueryCount to perform the CountByGroupId query
			return LemonAssessment::QueryCount(
				QQ::Equal(QQN::LemonAssessment()->GroupId, $intGroupId)
			, $objOptionalClauses
			);
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('lemon_assessment', 'id');
		...
		/**
		 * Delete this LemonAssessment
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this LemonAssessment with an unset primary key.');
		...
		/**
		 * Truncate lemon_assessment table
		 * @return void
		 */
		public static function Truncate() {
			...
			// Perform the Query
			$objDatabase->NonQuery('
				TRUNCATE `lemon_assessment`');
		}

		/**
		 * Reload this LemonAssessment from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved LemonAssessment object.');

			// Reload the Object
			$objReloaded = LemonAssessment::Load($this->intId);
		...
		public function Journal($strJournalCommand) {
			$objDatabase = LemonAssessment::GetDatabase()->JournalingDatabase;
		...
		public static function GetJournalForId($intId) {
			...
			$objResult = $objDatabase->Query('SELECT * FROM lemon_assessment WHERE id = ' .
				$objDatabase->SqlVariable($intId) . ' ORDER BY __sys_date');

			return LemonAssessment::InstantiateDbResult($objResult);
		}
		...
		public function GetJournal() {
			return LemonAssessment::GetJournalForId($this->intId);
		}
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case '_LemonAssessmentResultsAsAssessment':
					// Gets the value for the private _objLemonAssessmentResultsAsAssessment (Read-Only)
					// if set due to an expansion on the lemon_assessment_results.assessment_id reverse relationship
					// @return LemonAssessmentResults
					return $this->_objLemonAssessmentResultsAsAssessment;

				case '_LemonAssessmentResultsAsAssessmentArray':
					// Gets the value for the private _objLemonAssessmentResultsAsAssessmentArray (Read-Only)
					// if set due to an ExpandAsArray on the lemon_assessment_results.assessment_id reverse relationship
					// @return LemonAssessmentResults[]
					return (array) $this->_objLemonAssessmentResultsAsAssessmentArray;
			...
			switch ($strName) {
				...
				case 'User':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved User for this LemonAssessment');
				...
				case 'Company':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Company for this LemonAssessment');
				...
				case 'Resource':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Resource for this LemonAssessment');
				...
				case 'Group':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Group for this LemonAssessment');
		...
		// Related Objects' Methods for LemonAssessmentResultsAsAssessment
		//-------------------------------------------------------------------

		/**
		 * Gets all associated LemonAssessmentResultsesAsAssessment as an array of LemonAssessmentResults objects
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return LemonAssessmentResults[]
		*/ 
		public function GetLemonAssessmentResultsAsAssessmentArray($objOptionalClauses = null) {
			if ((is_null($this->intId)))
				return array();

			try {
				return LemonAssessmentResults::LoadArrayByAssessmentId($this->intId, $objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		/**
		 * Counts all associated LemonAssessmentResultsesAsAssessment
		 * @return int
		*/ 
		public function CountLemonAssessmentResultsesAsAssessment() {
			if ((is_null($this->intId)))
				return 0;

			return LemonAssessmentResults::CountByAssessmentId($this->intId);
		}

		/**
		 * Associates a LemonAssessmentResultsAsAssessment
		 * @param LemonAssessmentResults $objLemonAssessmentResults
		 * @return void
		*/ 
		public function AssociateLemonAssessmentResultsAsAssessment(LemonAssessmentResults $objLemonAssessmentResults) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateLemonAssessmentResultsAsAssessment on this unsaved LemonAssessment.');
			if ((is_null($objLemonAssessmentResults->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateLemonAssessmentResultsAsAssessment on this LemonAssessment with an unsaved LemonAssessmentResults.');
			...
			if ($objDatabase->JournalingDatabase) {
				$objLemonAssessmentResults->AssessmentId = $this->intId;
				$objLemonAssessmentResults->Journal('UPDATE');
			}
		}

		/**
		 * Unassociates a LemonAssessmentResultsAsAssessment
		 * @param LemonAssessmentResults $objLemonAssessmentResults
		 * @return void
		*/ 
		public function UnassociateLemonAssessmentResultsAsAssessment(LemonAssessmentResults $objLemonAssessmentResults) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateLemonAssessmentResultsAsAssessment on this unsaved LemonAssessment.');
			if ((is_null($objLemonAssessmentResults->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateLemonAssessmentResultsAsAssessment on this LemonAssessment with an unsaved LemonAssessmentResults.');
			...
			// Journaling
			if ($objDatabase->JournalingDatabase) {
				$objLemonAssessmentResults->AssessmentId = null;
				$objLemonAssessmentResults->Journal('UPDATE');
			}
		}

		/**
		 * Unassociates all LemonAssessmentResultsesAsAssessment
		 * @return void
		*/ 
		public function UnassociateAllLemonAssessmentResultsesAsAssessment() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateLemonAssessmentResultsAsAssessment on this unsaved LemonAssessment.');
			...
			// Journaling
			if ($objDatabase->JournalingDatabase) {
				foreach (LemonAssessmentResults::LoadArrayByAssessmentId($this->intId) as $objLemonAssessmentResults) {
					$objLemonAssessmentResults->AssessmentId = null;
					$objLemonAssessmentResults->Journal('UPDATE');
				}
			}
		...
		/**
		 * Deletes an associated LemonAssessmentResultsAsAssessment
		 * @param LemonAssessmentResults $objLemonAssessmentResults
		 * @return void
		*/ 
		public function DeleteAssociatedLemonAssessmentResultsAsAssessment(LemonAssessmentResults $objLemonAssessmentResults) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateLemonAssessmentResultsAsAssessment on this unsaved LemonAssessment.');
			if ((is_null($objLemonAssessmentResults->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateLemonAssessmentResultsAsAssessment on this LemonAssessment with an unsaved LemonAssessmentResults.');
		...
		/**
		 * Deletes all associated LemonAssessmentResultsesAsAssessment
		 * @return void
		*/ 
		public function DeleteAllLemonAssessmentResultsesAsAssessment() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateLemonAssessmentResultsAsAssessment on this unsaved LemonAssessment.');
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="LemonAssessment"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('LemonAssessment', $strComplexTypeArray)) {
				$strComplexTypeArray['LemonAssessment'] = LemonAssessment::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, LemonAssessment::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, LemonAssessment::GetSoapObjectFromObject($objObject, true));
	...
	class QQNodeLemonAssessment extends QQNode {
		protected $strTableName = 'lemon_assessment';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'LemonAssessment';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
	 ...
	 */
	class QQReverseReferenceNodeLemonAssessment extends QQReverseReferenceNode {
		protected $strTableName = 'lemon_assessment';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'LemonAssessment';
		public function __get($strName) {
