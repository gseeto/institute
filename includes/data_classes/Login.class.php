<?php
	...
	public static function LoadByUsernamePassword($strUsername, $strPassword) {
		...
		$objConditions = QQ::AndCondition($objConditions,QQ::Equal( QQN::Login()->Username, $strUsername));
		...
		if ($objLogin->Password == $strPassword) {
	...
	public function IsAdmin() {
		$objRole = Role::Load($this->intRoleId);
		if( $objRole->Name == 'Administrator') {
			return true;
		} else {
			return false;
		}
